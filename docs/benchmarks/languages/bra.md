# Braj Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,028 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,028 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `bra-default` Braj model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,028 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,028 distinct usable word forms">★★☆☆☆</span>. The exact count is **2,028 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `bra-default` | `1.0.0` | `BRA` | 1,246 | 2,028 | 2,035 | 1,246 | 789 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **2,035**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 1 | 0.049% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 120 | 5.897% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 602 | 29.582% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 1,246 | 61.229% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 66 | 3.243% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.656% | 99.366% | 99.839% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[bra-default]` | 0.201 | 0.061 | 40.3 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `bra-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 1,846 | 61.038% (59.839–62.638) | 6.586% (5.660–14.141) | 95.183% (90.812–97.324) |
| 20% | 1,614 | 63.139% (60.509–65.045) | 11.437% (5.352–12.898) | 95.683% (94.679–96.690) |
| 30% | 1,426 | 62.412% (61.544–64.414) | 11.372% (9.009–14.359) | 95.183% (94.839–95.757) |
| 40% | 1,220 | 62.479% (60.841–64.370) | 12.288% (10.474–14.110) | 94.779% (91.432–95.588) |
| 50% | 1,031 | 61.463% (60.674–65.661) | 12.010% (10.918–16.972) | 93.730% (92.765–95.666) |
| 60% | 842 | 61.447% (60.570–64.554) | 12.319% (11.628–18.611) | 93.763% (92.540–95.582) |
| 70% | 633 | 61.538% (60.436–63.714) | 13.060% (11.583–16.667) | 94.385% (91.935–95.989) |
| 80% | 398 | 64.500% (58.730–68.320) | 15.328% (9.896–16.556) | 93.574% (91.935–96.386) |
| 90% | 197 | 65.641% (59.494–73.171) | 16.964% (7.500–18.947) | 94.355% (92.800–97.600) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **6.586%** at 10% training knowledge to **16.964%** at 90%, a measured **+10.378 percentage-point** change.
- Unseen all-form exactness moves from **61.038%** at 10% training knowledge to **65.641%** at 90%, a measured **+4.603 percentage-point** change.
- Preservation of unseen already-root forms moves from **95.183%** at 10% training knowledge to **94.355%** at 90%, a measured **-0.828 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `BRA` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `bra-default`, loaded from classpath resource `org/egothor/stemmer/models/bra-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.989171** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.989171** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.989171|0.000000%|2.165725%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.978343|1.000000|0.989171|0.999966|0.000034|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.995592|0.989053|0.982599|0.978343|0.989112|0.989095|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|3117|0|69|2052192|0 / 2052192|69 / 3186|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|3186|0|0|2052192|0 / 2052192|0 / 3186|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|69|0|0|7|0.345168%|2|2035|
