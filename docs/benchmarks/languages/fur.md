# Friulian Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 5,007 distinct usable word forms" title="Relative dictionary size 3 of 5; 5,007 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `fur-default` Friulian model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 5,007 distinct usable word forms" title="Relative dictionary size 3 of 5; 5,007 distinct usable word forms">★★★☆☆</span>. The exact count is **5,007 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `fur-default` | `1.0.0` | `FUR` | 168 | 5,007 | 5,017 | 168 | 4,849 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **5,017**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 15 | 0.299% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 4,067 | 81.064% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 363 | 7.235% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 170 | 3.388% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 402 | 8.013% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.801% | 99.794% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[fur-default]` | 0.247 | 0.075 | 49.4 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `fur-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 4,507 | 63.002% (60.674–69.770) | 61.880% (59.381–68.883) | 96.026% (95.364–98.013) |
| 20% | 4,000 | 68.530% (67.927–71.704) | 67.493% (66.891–70.903) | 96.269% (94.776–98.507) |
| 30% | 3,522 | 71.275% (67.235–75.092) | 70.437% (66.186–74.404) | 96.610% (94.915–98.305) |
| 40% | 3,009 | 71.424% (69.042–75.573) | 70.651% (68.060–74.940) | 95.050% (94.000–97.980) |
| 50% | 2,499 | 70.991% (70.148–74.359) | 70.140% (69.234–73.726) | 94.048% (92.771–100.000) |
| 60% | 1,991 | 72.060% (70.200–73.839) | 71.258% (69.271–72.934) | 95.522% (93.939–100.000) |
| 70% | 1,485 | 76.142% (73.670–78.851) | 75.452% (72.911–78.182) | 96.000% (94.000–100.000) |
| 80% | 1,010 | 75.522% (71.767–84.378) | 74.691% (70.787–83.934) | 100.000% (94.118–100.000) |
| 90% | 505 | 78.968% (61.057–90.891) | 78.234% (59.919–90.574) | 100.000% (88.235–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **61.880%** at 10% training knowledge to **78.234%** at 90%, a measured **+16.354 percentage-point** change.
- Unseen all-form exactness moves from **63.002%** at 10% training knowledge to **78.968%** at 90%, a measured **+15.966 percentage-point** change.
- Preservation of unseen already-root forms moves from **96.026%** at 10% training knowledge to **100.000%** at 90%, a measured **+3.974 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `FUR` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `fur-default`, loaded from classpath resource `org/egothor/stemmer/models/fur-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.997938** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.997938** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.997938|0.000000%|0.412476%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.995875|1.000000|0.997938|0.999976|0.000024|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.999172|0.997933|0.996697|0.995875|0.997935|0.997924|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|72190|0|299|12460032|0 / 12460032|299 / 72489|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|72489|0|0|12460032|0 / 12460032|0 / 72489|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|299|0|0|10|0.199720%|2|5017|
