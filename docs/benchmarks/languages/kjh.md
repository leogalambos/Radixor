# Khakas Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,172 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,172 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `kjh-default` Khakas model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,172 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,172 distinct usable word forms">★★☆☆☆</span>. The exact count is **1,172 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `kjh-default` | `1.0.0` | `KJH` | 74 | 1,172 | 1,172 | 74 | 1,098 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **1,172**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 7 | 0.597% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 1,091 | 93.089% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 74 | 6.314% |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[kjh-default]` | 0.157 | 0.039 | 31.5 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `kjh-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 1,061 | 67.295% (61.038–73.917) | 65.392% (58.812–72.663) | 95.522% (92.537–98.507) |
| 20% | 934 | 72.883% (68.128–76.231) | 71.167% (65.982–75.200) | 98.305% (91.525–100.000) |
| 30% | 822 | 78.710% (73.082–88.443) | 77.922% (71.521–87.953) | 96.154% (90.385–98.077) |
| 40% | 696 | 88.429% (75.325–90.531) | 87.957% (73.960–90.505) | 95.455% (88.636–95.455) |
| 50% | 585 | 87.521% (73.024–91.610) | 87.226% (71.560–91.590) | 91.892% (89.189–94.595) |
| 60% | 473 | 90.063% (86.469–92.437) | 90.068% (86.230–92.152) | 93.333% (90.000–96.667) |
| 70% | 346 | 90.517% (83.815–92.264) | 90.184% (83.642–92.049) | 95.455% (86.364–95.455) |
| 80% | 236 | 88.983% (86.809–89.496) | 88.739% (86.364–89.140) | 93.333% (80.000–100.000) |
| 90% | 110 | 89.091% (83.636–97.297) | 90.291% (83.495–97.115) | 85.714% (71.429–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **65.392%** at 10% training knowledge to **90.291%** at 90%, a measured **+24.899 percentage-point** change.
- Unseen all-form exactness moves from **67.295%** at 10% training knowledge to **89.091%** at 90%, a measured **+21.796 percentage-point** change.
- Preservation of unseen already-root forms moves from **95.522%** at 10% training knowledge to **85.714%** at 90%, a measured **-9.808 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `KJH` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `kjh-default`, loaded from classpath resource `org/egothor/stemmer/models/kjh-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|8700|0|0|677506|0 / 677506|0 / 8700|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|8700|0|0|677506|0 / 677506|0 / 8700|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|0|0|0|0|0.000000%|1|1172|
