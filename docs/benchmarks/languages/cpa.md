# Copala Triqui Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,741 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,741 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `cpa-default` Copala Triqui model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,741 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,741 distinct usable word forms">★★☆☆☆</span>. The exact count is **2,741 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `cpa-default` | `1.0.0` | `CPA` | 555 | 2,741 | 3,090 | 555 | 2,535 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **3,090**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 289 | 9.353% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 1,944 | 62.913% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 1 | 0.032% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 649 | 21.003% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 207 | 6.699% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 88.706% | 86.272% | 99.820% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[cpa-default]` | 0.361 | 0.086 | 72.2 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `cpa-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 2,709 | 23.946% (22.148–24.859) | 7.973% (5.415–8.541) | 97.732% (95.910–99.588) |
| 20% | 2,315 | 24.297% (22.637–24.622) | 7.732% (5.851–8.413) | 97.163% (96.706–98.595) |
| 30% | 1,993 | 24.277% (23.691–24.887) | 7.396% (6.785–8.292) | 98.374% (97.581–98.919) |
| 40% | 1,656 | 24.494% (23.913–26.145) | 7.988% (6.543–9.201) | 98.089% (96.743–99.035) |
| 50% | 1,343 | 24.799% (23.973–26.585) | 8.594% (6.117–9.212) | 98.077% (97.200–99.219) |
| 60% | 1,047 | 25.766% (24.045–26.249) | 8.747% (6.120–9.187) | 98.500% (97.500–99.034) |
| 70% | 777 | 25.225% (24.399–25.732) | 7.414% (6.864–8.504) | 98.693% (96.026–99.333) |
| 80% | 507 | 25.290% (25.000–26.411) | 7.226% (6.952–9.250) | 97.959% (97.030–100.000) |
| 90% | 259 | 24.906% (21.933–26.606) | 5.430% (3.158–9.390) | 98.000% (97.917–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **7.973%** at 10% training knowledge to **5.430%** at 90%, a measured **-2.543 percentage-point** change.
- Unseen all-form exactness moves from **23.946%** at 10% training knowledge to **24.906%** at 90%, a measured **+0.960 percentage-point** change.
- Preservation of unseen already-root forms moves from **97.732%** at 10% training knowledge to **98.000%** at 90%, a measured **+0.268 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `CPA` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `cpa-default`, loaded from classpath resource `org/egothor/stemmer/models/cpa-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.895664** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.895664** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.895664|0.000000%|20.867209%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.791328|1.000000|0.895664|0.999508|0.000492|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.949902|0.883510|0.825792|0.791328|0.889566|0.889347|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|7008|0|1848|3746314|0 / 3746314|1848 / 8856|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|8856|0|0|3746314|0 / 3746314|0 / 8856|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|1848|0|0|307|11.200292%|4|3090|
