# Norwegian Nynorsk Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 16,937 distinct usable word forms" title="Relative dictionary size 4 of 5; 16,937 distinct usable word forms">★★★★☆</span>
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `nn-no-default` | `1.0.0` | `NN_NO` | 4,688 | 16,937 | 19,651 | 6,089 | 13,562 | changed tokens | 13,562 |
...
| Official Snowball direct (Java) | 60.974% | 60.212% | 62.670% | Official Snowball generated Java stemmer; rule-based suffix algorithm. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[nn-no-default]` | 0.735 | 0.136 | 54.2 | 1.000 | Radixor dictionary-trained patch-command stemmer. |
| Official Snowball direct (Java) | `snowballDirect[NORWEGIAN_NYNORSK]` | 1.312 | 0.175 | 96.7 | 1.785 | Official Snowball generated Java stemmer; direct API. |
| Lucene SnowballFilter | `luceneSnowballFilter[NORWEGIAN_NYNORSK]` | 1.551 | 0.248 | 114.4 | 2.111 | Lucene TokenFilter path around Snowball; includes TokenStream overhead. |
...
- Median exactness on genuinely unseen changed forms moves from **51.191%** at 10% training knowledge to **70.338%** at 90%, a measured **+19.147 percentage-point** change.
- Unseen all-form exactness moves from **63.195%** at 10% training knowledge to **78.608%** at 90%, a measured **+15.413 percentage-point** change.
- Preservation of unseen already-root forms moves from **90.470%** at 10% training knowledge to **95.153%** at 90%, a measured **+4.683 percentage-point** change.
