# Temoaya Otomi Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 3,417 distinct usable word forms" title="Relative dictionary size 3 of 5; 3,417 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `ote-default` Temoaya Otomi model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 3,417 distinct usable word forms" title="Relative dictionary size 3 of 5; 3,417 distinct usable word forms">★★★☆☆</span>. The exact count is **3,417 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `ote-default` | `1.0.0` | `OTE` | 2,026 | 3,417 | 3,564 | 2,026 | 1,538 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **3,564**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 16 | 0.449% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 1,438 | 40.348% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 2,108 | 59.147% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 2 | 0.056% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 95.875% | 90.637% | 99.852% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[ote-default]` | 0.341 | 0.082 | 68.3 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `ote-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 3,179 | 57.049% (56.368–58.131) | 7.778% (6.250–9.824) | 93.985% (93.341–94.615) |
| 20% | 2,805 | 57.553% (57.468–57.596) | 8.870% (7.305–10.067) | 93.540% (92.742–94.776) |
| 30% | 2,441 | 57.918% (57.681–58.251) | 8.317% (7.157–10.634) | 94.872% (93.138–95.306) |
| 40% | 2,076 | 58.402% (58.382–58.903) | 8.121% (7.859–10.162) | 95.409% (93.395–95.424) |
| 50% | 1,709 | 58.919% (58.534–59.450) | 8.146% (6.863–9.843) | 95.762% (94.260–96.690) |
| 60% | 1,361 | 59.442% (58.948–59.752) | 7.958% (7.570–9.725) | 96.207% (93.962–97.478) |
| 70% | 1,014 | 59.724% (59.002–60.926) | 8.451% (7.294–11.083) | 96.441% (94.128–97.293) |
| 80% | 668 | 60.546% (58.555–62.267) | 8.519% (7.609–10.887) | 96.134% (94.444–97.201) |
| 90% | 329 | 61.515% (60.182–63.665) | 7.463% (5.344–14.179) | 96.907% (95.000–98.469) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **7.778%** at 10% training knowledge to **7.463%** at 90%, a measured **-0.315 percentage-point** change.
- Unseen all-form exactness moves from **57.049%** at 10% training knowledge to **61.515%** at 90%, a measured **+4.466 percentage-point** change.
- Preservation of unseen already-root forms moves from **93.985%** at 10% training knowledge to **96.907%** at 90%, a measured **+2.923 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `OTE` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `ote-default`, loaded from classpath resource `org/egothor/stemmer/models/ote-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.953277** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.953277** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.953277|0.000000%|9.344581%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.906554|1.000000|0.953277|0.999975|0.000025|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.979801|0.950987|0.923820|0.906554|0.952131|0.952120|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1397|0|144|5834695|0 / 5834695|144 / 1541|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|1541|0|0|5834695|0 / 5834695|0 / 1541|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|144|0|0|143|4.184958%|3|3564|
