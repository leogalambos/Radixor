# Low German Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,495 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,495 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `nds-default` Low German model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,495 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,495 distinct usable word forms">★★☆☆☆</span>. The exact count is **2,495 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `nds-default` | `1.0.0` | `NDS` | 325 | 2,495 | 2,545 | 325 | 2,220 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **2,545**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 109 | 4.283% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 1,887 | 74.145% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 162 | 6.365% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 331 | 13.006% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 56 | 2.200% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 98.035% | 97.748% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[nds-default]` | 0.288 | 0.066 | 57.7 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `nds-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 2,289 | 29.623% (26.394–33.814) | 20.833% (18.603–25.876) | 90.000% (80.069–92.808) |
| 20% | 2,032 | 33.560% (32.430–37.451) | 25.889% (23.785–30.095) | 89.535% (86.873–91.506) |
| 30% | 1,780 | 39.446% (37.875–42.391) | 32.172% (30.344–35.085) | 90.265% (86.726–96.000) |
| 40% | 1,526 | 43.559% (39.043–44.233) | 36.329% (32.077–37.698) | 88.601% (87.629–97.927) |
| 50% | 1,274 | 44.861% (42.048–45.997) | 37.751% (35.106–38.744) | 93.125% (88.889–96.855) |
| 60% | 1,016 | 44.389% (42.421–49.650) | 37.244% (35.738–43.070) | 93.023% (88.372–96.850) |
| 70% | 754 | 46.997% (42.308–53.774) | 40.179% (35.258–47.214) | 94.845% (90.625–97.917) |
| 80% | 501 | 49.301% (45.309–54.851) | 42.202% (37.385–48.409) | 98.438% (96.825–98.462) |
| 90% | 246 | 48.770% (38.846–54.545) | 41.509% (31.004–47.964) | 96.875% (93.333–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **20.833%** at 10% training knowledge to **41.509%** at 90%, a measured **+20.676 percentage-point** change.
- Unseen all-form exactness moves from **29.623%** at 10% training knowledge to **48.770%** at 90%, a measured **+19.147 percentage-point** change.
- Preservation of unseen already-root forms moves from **90.000%** at 10% training knowledge to **96.875%** at 90%, a measured **+6.875 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `NDS` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `nds-default`, loaded from classpath resource `org/egothor/stemmer/models/nds-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.980207** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.980207** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.980207|0.000000%|3.958656%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.960413|1.000000|0.980207|0.999877|0.000123|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.991824|0.979807|0.968078|0.960413|0.980007|0.979946|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|9292|0|383|3101590|0 / 3101590|383 / 9675|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|9675|0|0|3101590|0 / 3101590|0 / 9675|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|383|0|0|48|1.923848%|3|2545|
