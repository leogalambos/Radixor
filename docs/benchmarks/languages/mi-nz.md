# Maori Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 207 distinct usable word forms" title="Relative dictionary size 1 of 5; 207 distinct usable word forms">★☆☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `mi-nz-default` Maori model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 207 distinct usable word forms" title="Relative dictionary size 1 of 5; 207 distinct usable word forms">★☆☆☆☆</span>. The exact count is **207 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `mi-nz-default` | `1.0.0` | `MI_NZ` | 104 | 207 | 208 | 104 | 104 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **208**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 8 | 3.846% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 96 | 46.154% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 104 | 50.000% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.519% | 99.038% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[mi-nz-default]` | 0.127 | 0.039 | 25.4 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `mi-nz-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 188 | 70.213% (57.447–75.000) | 41.489% (17.021–52.128) | 97.872% (97.872–98.936) |
| 20% | 166 | 67.470% (62.048–75.904) | 39.759% (25.301–54.217) | 97.590% (95.181–98.795) |
| 30% | 146 | 67.123% (64.384–77.931) | 34.247% (30.137–58.333) | 98.630% (94.521–100.000) |
| 40% | 124 | 70.161% (66.935–79.675) | 41.935% (33.871–60.656) | 98.387% (96.774–100.000) |
| 50% | 103 | 67.308% (66.346–72.816) | 36.538% (33.333–47.059) | 98.077% (96.154–100.000) |
| 60% | 83 | 68.675% (63.095–71.084) | 36.585% (28.571–41.463) | 97.619% (97.619–100.000) |
| 70% | 61 | 67.213% (62.903–75.410) | 33.333% (25.806–50.000) | 100.000% (96.774–100.000) |
| 80% | 41 | 68.293% (58.537–76.190) | 40.000% (20.000–52.381) | 95.238% (95.238–100.000) |
| 90% | 20 | 70.000% (65.000–75.000) | 40.000% (30.000–50.000) | 100.000% (90.000–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **41.489%** at 10% training knowledge to **40.000%** at 90%, a measured **-1.489 percentage-point** change.
- Unseen all-form exactness moves from **70.213%** at 10% training knowledge to **70.000%** at 90%, a measured **-0.213 percentage-point** change.
- Preservation of unseen already-root forms moves from **97.872%** at 10% training knowledge to **100.000%** at 90%, a measured **+2.128 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `MI_NZ` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `mi-nz-default`, loaded from classpath resource `org/egothor/stemmer/models/mi-nz-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.995192** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.995192** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.995192|0.000000%|0.961538%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.990385|1.000000|0.995192|0.999953|0.000047|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.998062|0.995169|0.992293|0.990385|0.995181|0.995157|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|103|0|1|21217|0 / 21217|1 / 104|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|104|0|0|21217|0 / 21217|0 / 104|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|1|0|0|1|0.483092%|2|208|
