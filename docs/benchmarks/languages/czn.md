# Zenzontepec Chatino Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,864 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,864 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `czn-default` Zenzontepec Chatino model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,864 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,864 distinct usable word forms">★★☆☆☆</span>. The exact count is **1,864 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `czn-default` | `1.0.0` | `CZN` | 386 | 1,864 | 1,915 | 386 | 1,529 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **1,915**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 1,524 | 79.582% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 391 | 20.418% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 97.337% | 96.664% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[czn-default]` | 0.433 | 0.086 | 86.5 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `czn-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 1,710 | 20.175% (19.977–20.258) | 0.000% | 99.711% (98.844–100.000) |
| 20% | 1,515 | 20.198% (19.947–20.305) | 0.000% | 99.673% (98.377–100.000) |
| 30% | 1,318 | 20.243% (20.091–20.258) | 0.000% | 99.254% (98.513–99.627) |
| 40% | 1,126 | 20.213% (20.125–20.321) | 0.000% | 98.701% (98.261–99.134) |
| 50% | 931 | 20.364% (20.151–20.408) | 0.000% | 98.446% (97.906–98.958) |
| 60% | 739 | 20.298% (20.134–20.353) | 0.000% | 98.039% (97.368–98.693) |
| 70% | 553 | 20.253% (19.821–20.615) | 0.000% | 97.391% (95.690–99.130) |
| 80% | 365 | 19.780% (19.452–20.596) | 0.000% | 96.000% (94.667–98.701) |
| 90% | 185 | 20.000% (19.149–20.000) | 0.000% | 94.737% (94.737–97.368) |
...
- Unseen all-form exactness moves from **20.175%** at 10% training knowledge to **20.000%** at 90%, a measured **-0.175 percentage-point** change.
- Preservation of unseen already-root forms moves from **99.711%** at 10% training knowledge to **94.737%** at 90%, a measured **-4.974 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `CZN` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `czn-default`, loaded from classpath resource `org/egothor/stemmer/models/czn-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.973968** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.973968** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.973968|0.000000%|5.206416%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.947936|1.000000|0.973968|0.999886|0.000114|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.989135|0.973272|0.957910|0.947936|0.973620|0.973564|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|3605|0|198|1732513|0 / 1732513|198 / 3803|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|3803|0|0|1732513|0 / 1732513|0 / 3803|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|198|0|0|50|2.682403%|3|1915|
