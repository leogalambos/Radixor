# Old Saxon Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 12,361 distinct usable word forms" title="Relative dictionary size 3 of 5; 12,361 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `osx-default` Old Saxon model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 12,361 distinct usable word forms" title="Relative dictionary size 3 of 5; 12,361 distinct usable word forms">★★★☆☆</span>. The exact count is **12,361 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `osx-default` | `1.0.0` | `OSX` | 863 | 12,361 | 12,553 | 863 | 11,690 | changed tokens | 11,690 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **12,553**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 65 | 0.518% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 9,449 | 75.273% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 1,678 | 13.367% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 886 | 7.058% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 475 | 3.784% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 98.470% | 98.392% | 99.537% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[osx-default]` | 0.998 | 0.148 | 85.4 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `osx-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 11,355 | 26.441% (23.697–30.817) | 21.522% (18.468–26.220) | 93.264% (91.495–95.484) |
| 20% | 10,026 | 35.174% (31.506–36.436) | 30.773% (26.789–32.407) | 93.851% (90.497–96.070) |
| 30% | 8,715 | 40.138% (38.413–41.793) | 36.122% (34.265–38.163) | 94.649% (90.970–95.826) |
| 40% | 7,379 | 44.655% (42.126–46.890) | 41.008% (38.397–43.485) | 93.177% (90.607–94.347) |
| 50% | 6,086 | 48.011% (45.939–52.136) | 44.683% (42.393–49.134) | 92.453% (91.962–94.588) |
| 60% | 4,808 | 48.605% (45.812–53.078) | 45.007% (42.048–50.067) | 93.491% (92.647–96.481) |
| 70% | 3,616 | 52.431% (49.034–55.515) | 49.493% (45.697–52.512) | 93.333% (90.980–94.902) |
| 80% | 2,407 | 54.343% (47.071–56.514) | 51.569% (43.605–53.827) | 92.442% (91.765–95.152) |
| 90% | 1,168 | 53.448% (46.839–53.853) | 50.220% (43.487–50.693) | 94.118% (91.139–97.590) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **21.522%** at 10% training knowledge to **50.220%** at 90%, a measured **+28.698 percentage-point** change.
- Unseen all-form exactness moves from **26.441%** at 10% training knowledge to **53.448%** at 90%, a measured **+27.007 percentage-point** change.
- Preservation of unseen already-root forms moves from **93.264%** at 10% training knowledge to **94.118%** at 90%, a measured **+0.853 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `OSX` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `osx-default`, loaded from classpath resource `org/egothor/stemmer/models/osx-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.987927** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.987927** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.987927|0.000000%|2.414654%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.975853|1.000000|0.987927|0.999968|0.000032|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.995076|0.987779|0.980589|0.975853|0.987853|0.987837|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|98933|0|2448|76289599|0 / 76289599|2448 / 101381|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|101381|0|0|76289599|0 / 76289599|0 / 101381|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|2448|0|0|191|1.545182%|3|12553|
