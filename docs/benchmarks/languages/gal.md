# Galolen Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 25,436 distinct usable word forms" title="Relative dictionary size 4 of 5; 25,436 distinct usable word forms">★★★★☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `gal-default` Galolen model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 25,436 distinct usable word forms" title="Relative dictionary size 4 of 5; 25,436 distinct usable word forms">★★★★☆</span>. The exact count is **25,436 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `gal-default` | `1.0.0` | `GAL` | 486 | 25,436 | 26,195 | 486 | 25,709 | changed tokens | 25,709 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **26,195**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 360 | 1.374% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 15,138 | 57.790% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 9,258 | 35.343% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 488 | 1.863% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 951 | 3.630% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 97.103% | 97.048% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[gal-default]` | 1.566 | 0.357 | 60.9 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `gal-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 23,414 | 68.424% (62.659–71.339) | 67.824% (61.966–70.845) | 99.085% (97.254–100.000) |
| 20% | 20,701 | 70.301% (66.061–73.722) | 69.742% (65.425–73.231) | 99.229% (98.201–99.486) |
| 30% | 18,051 | 73.281% (71.502–75.971) | 72.785% (70.964–75.510) | 99.412% (98.824–100.000) |
| 40% | 15,410 | 77.051% (75.106–77.968) | 76.628% (74.635–77.541) | 98.969% (97.945–100.000) |
| 50% | 12,745 | 77.875% (76.205–80.400) | 77.476% (75.790–80.027) | 99.585% (97.531–99.588) |
| 60% | 10,155 | 79.048% (78.338–81.300) | 78.656% (77.914–80.946) | 99.485% (98.969–100.000) |
| 70% | 7,535 | 81.102% (77.226–84.013) | 80.731% (76.790–83.695) | 100.000% (99.315–100.000) |
| 80% | 5,001 | 81.528% (76.585–83.327) | 81.162% (76.142–83.020) | 100.000% (98.969–100.000) |
| 90% | 2,551 | 81.665% (80.263–89.176) | 81.307% (79.911–88.961) | 100.000% (97.959–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **67.824%** at 10% training knowledge to **81.307%** at 90%, a measured **+13.483 percentage-point** change.
- Unseen all-form exactness moves from **68.424%** at 10% training knowledge to **81.665%** at 90%, a measured **+13.241 percentage-point** change.
- Preservation of unseen already-root forms moves from **99.085%** at 10% training knowledge to **100.000%** at 90%, a measured **+0.915 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `GAL` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `gal-default`, loaded from classpath resource `org/egothor/stemmer/models/gal-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.983508** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.983508** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.983508|0.000000%|3.298345%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.967017|1.000000|0.983508|0.999930|0.000070|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.993225|0.983232|0.973438|0.967017|0.983370|0.983336|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|660364|0|22524|322799442|0 / 322799442|22524 / 682888|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|682888|0|0|322799442|0 / 322799442|0 / 682888|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|22524|0|0|752|2.956440%|6|26195|
