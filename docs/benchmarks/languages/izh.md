# Ingrian Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,026 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,026 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `izh-default` Ingrian model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,026 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,026 distinct usable word forms">★★☆☆☆</span>. The exact count is **1,026 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `izh-default` | `1.0.0` | `IZH` | 50 | 1,026 | 1,026 | 50 | 976 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **1,026**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 683 | 66.569% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 293 | 28.558% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 50 | 4.873% |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[izh-default]` | 0.245 | 0.058 | 49.0 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `izh-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 923 | 14.843% (8.234–16.143) | 11.060% (5.011–12.984) | 82.222% (71.111–93.333) |
| 20% | 819 | 14.408% (12.317–16.361) | 10.398% (8.184–12.580) | 90.000% (80.000–95.000) |
| 30% | 716 | 17.246% (14.385–19.720) | 13.158% (10.866–15.735) | 94.286% (74.286–97.143) |
| 40% | 613 | 15.447% (12.235–24.188) | 11.282% (8.576–20.819) | 90.000% (76.667–96.667) |
| 50% | 512 | 23.183% (15.595–26.953) | 19.421% (11.475–23.614) | 96.000% (88.000–96.000) |
| 60% | 408 | 22.542% (14.976–26.225) | 18.892% (10.914–23.454) | 90.000% (80.000–95.000) |
| 70% | 308 | 24.503% (18.065–32.692) | 21.603% (14.237–29.630) | 93.333% (80.000–100.000) |
| 80% | 206 | 32.500% (18.537–38.350) | 29.474% (14.359–35.204) | 100.000% (90.000–100.000) |
| 90% | 103 | 31.068% (4.808–38.679) | 28.571% (0.000–36.634) | 100.000% (80.000–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **11.060%** at 10% training knowledge to **28.571%** at 90%, a measured **+17.511 percentage-point** change.
- Unseen all-form exactness moves from **14.843%** at 10% training knowledge to **31.068%** at 90%, a measured **+16.225 percentage-point** change.
- Preservation of unseen already-root forms moves from **82.222%** at 10% training knowledge to **100.000%** at 90%, a measured **+17.778 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `IZH` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `izh-default`, loaded from classpath resource `org/egothor/stemmer/models/izh-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|10058|0|0|515767|0 / 515767|0 / 10058|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|10058|0|0|515767|0 / 515767|0 / 10058|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|0|0|0|0|0.000000%|1|1026|
