# Middle French Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 27,102 distinct usable word forms" title="Relative dictionary size 4 of 5; 27,102 distinct usable word forms">★★★★☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `frm-default` Middle French model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 27,102 distinct usable word forms" title="Relative dictionary size 4 of 5; 27,102 distinct usable word forms">★★★★☆</span>. The exact count is **27,102 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `frm-default` | `1.0.0` | `FRM` | 603 | 27,102 | 27,314 | 603 | 26,711 | changed tokens | 26,711 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **27,314**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 549 | 2.010% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 14,661 | 53.676% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 10,339 | 37.852% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 603 | 2.208% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 1,162 | 4.254% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.224% | 99.206% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[frm-default]` | 1.804 | 0.369 | 67.6 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `frm-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 24,561 | 75.715% (67.286–79.763) | 75.188% (66.585–79.341) | 98.343% (98.343–100.000) |
| 20% | 21,738 | 76.858% (71.690–78.493) | 76.334% (71.072–78.018) | 99.378% (98.133–100.000) |
| 30% | 18,971 | 77.220% (72.026–80.620) | 76.750% (71.416–80.192) | 99.526% (97.867–99.763) |
| 40% | 16,254 | 77.925% (76.130–80.706) | 77.429% (75.615–80.280) | 99.448% (97.514–99.724) |
| 50% | 13,506 | 78.703% (76.302–79.765) | 78.235% (75.765–79.311) | 99.668% (99.336–99.668) |
| 60% | 10,807 | 77.429% (75.058–81.635) | 76.913% (74.495–81.226) | 99.585% (99.585–100.000) |
| 70% | 8,121 | 78.997% (76.000–83.088) | 78.533% (75.466–82.715) | 99.448% (99.448–100.000) |
| 80% | 5,421 | 79.722% (78.325–83.290) | 79.283% (77.824–82.909) | 100.000% (99.174–100.000) |
| 90% | 2,680 | 80.852% (77.393–87.793) | 80.409% (76.870–87.519) | 100.000% |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **75.188%** at 10% training knowledge to **80.409%** at 90%, a measured **+5.221 percentage-point** change.
- Unseen all-form exactness moves from **75.715%** at 10% training knowledge to **80.852%** at 90%, a measured **+5.137 percentage-point** change.
- Preservation of unseen already-root forms moves from **98.343%** at 10% training knowledge to **100.000%** at 90%, a measured **+1.657 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `FRM` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `frm-default`, loaded from classpath resource `org/egothor/stemmer/models/frm-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.996418** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.996418** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.996418|0.000000%|0.716369%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.992836|1.000000|0.996418|0.999988|0.000012|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.998559|0.996405|0.994261|0.992836|0.996412|0.996406|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|602463|0|4347|366638841|0 / 366638841|4347 / 606810|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|606810|0|0|366638841|0 / 366638841|0 / 606810|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|4347|0|0|212|0.782230%|2|27314|
