# Haida Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 5,385 distinct usable word forms" title="Relative dictionary size 3 of 5; 5,385 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `hai-default` Haida model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 5,385 distinct usable word forms" title="Relative dictionary size 3 of 5; 5,385 distinct usable word forms">★★★☆☆</span>. The exact count is **5,385 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `hai-default` | `1.0.0` | `HAI` | 36 | 5,385 | 5,385 | 36 | 5,349 | changed tokens | 5,349 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **5,385**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 579 | 10.752% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 4,770 | 88.579% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 36 | 0.669% |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[hai-default]` | 0.393 | 0.056 | 73.4 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `hai-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 4,770 | 52.485% (50.388–61.069) | 52.164% (50.123–60.848) | 96.875% (90.625–100.000) |
| 20% | 4,310 | 58.320% (50.980–59.165) | 58.084% (50.673–58.888) | 96.552% (93.103–100.000) |
| 30% | 3,722 | 58.958% (55.611–60.183) | 58.734% (55.344–59.940) | 96.000% (92.000–100.000) |
| 40% | 3,261 | 61.628% (41.138–69.599) | 61.435% (40.735–69.485) | 90.909% (86.364–100.000) |
| 50% | 2,767 | 64.657% (47.677–70.401) | 64.499% (47.318–70.280) | 88.889% (77.778–100.000) |
| 60% | 2,152 | 62.207% (50.640–74.117) | 62.041% (50.347–73.994) | 85.714% (78.571–92.857) |
| 70% | 1,690 | 65.071% (58.885–73.609) | 64.961% (58.654–73.496) | 90.909% (81.818–90.909) |
| 80% | 1,076 | 57.621% (54.498–67.721) | 57.530% (54.268–67.603) | 85.714% (71.429–85.714) |
| 90% | 614 | 77.850% (52.512–81.922) | 77.705% (52.202–81.803) | 100.000% (75.000–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **52.164%** at 10% training knowledge to **77.705%** at 90%, a measured **+25.541 percentage-point** change.
- Unseen all-form exactness moves from **52.485%** at 10% training knowledge to **77.850%** at 90%, a measured **+25.365 percentage-point** change.
- Preservation of unseen already-root forms moves from **96.875%** at 10% training knowledge to **100.000%** at 90%, a measured **+3.125 percentage-point** change.
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|407606|0|0|14088814|0 / 14088814|0 / 407606|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|407606|0|0|14088814|0 / 14088814|0 / 407606|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|0|0|0|0|0.000000%|1|5385|
