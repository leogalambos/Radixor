# Classical Syriac Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 27,529 distinct usable word forms" title="Relative dictionary size 4 of 5; 27,529 distinct usable word forms">★★★★☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `syc-default` Classical Syriac model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 27,529 distinct usable word forms" title="Relative dictionary size 4 of 5; 27,529 distinct usable word forms">★★★★☆</span>. The exact count is **27,529 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `syc-default` | `1.0.0` | `SYC` | 3,257 | 27,529 | 27,703 | 3,257 | 24,446 | changed tokens | 24,446 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **27,703**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 170 | 0.614% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 23,586 | 85.139% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 36 | 0.130% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 3,257 | 11.757% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 654 | 2.361% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.372% | 99.333% | 99.662% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[syc-default]` | 3.278 | 0.427 | 134.1 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `syc-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 24,625 | 16.381% (16.169–17.052) | 5.476% (5.101–6.191) | 97.439% (96.689–99.215) |
| 20% | 22,088 | 16.818% (16.312–17.279) | 6.306% (5.404–6.467) | 97.964% (96.269–98.692) |
| 30% | 19,247 | 17.482% (16.726–17.630) | 6.526% (6.381–7.017) | 97.889% (97.451–98.067) |
| 40% | 16,637 | 17.124% (16.990–17.465) | 6.498% (6.049–6.680) | 98.048% (97.228–98.821) |
| 50% | 13,893 | 17.282% (16.724–17.405) | 6.568% (6.212–6.930) | 97.901% (97.102–98.149) |
| 60% | 11,223 | 17.250% (16.964–17.541) | 6.700% (6.341–7.340) | 97.769% (96.993–98.228) |
| 70% | 8,401 | 17.274% (17.188–17.984) | 7.136% (6.636–7.313) | 97.844% (97.216–98.251) |
| 80% | 5,632 | 16.903% (16.178–18.162) | 6.553% (5.979–7.454) | 97.991% (97.531–98.302) |
| 90% | 2,706 | 18.071% (16.174–19.930) | 6.970% (6.250–8.713) | 98.452% (97.840–98.754) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **5.476%** at 10% training knowledge to **6.970%** at 90%, a measured **+1.494 percentage-point** change.
- Unseen all-form exactness moves from **16.381%** at 10% training knowledge to **18.071%** at 90%, a measured **+1.690 percentage-point** change.
- Preservation of unseen already-root forms moves from **97.439%** at 10% training knowledge to **98.452%** at 90%, a measured **+1.013 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `SYC` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `syc-default`, loaded from classpath resource `org/egothor/stemmer/models/syc-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.993956** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.993956** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.993956|0.000000%|1.208824%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.987912|1.000000|0.993956|0.999989|0.000011|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.997559|0.993919|0.990306|0.987912|0.993938|0.993932|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|352480|0|4313|378552363|0 / 378552363|4313 / 356793|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|356793|0|0|378552363|0 / 378552363|0 / 356793|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|4313|0|0|174|0.632061%|2|27703|
