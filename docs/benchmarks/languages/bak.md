# Bashkir Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 10,723 distinct usable word forms" title="Relative dictionary size 3 of 5; 10,723 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `bak-default` Bashkir model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 10,723 distinct usable word forms" title="Relative dictionary size 3 of 5; 10,723 distinct usable word forms">★★★☆☆</span>. The exact count is **10,723 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `bak-default` | `1.0.0` | `BAK` | 1,059 | 10,723 | 10,742 | 1,059 | 9,683 | changed tokens | 9,683 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **10,742**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 9,692 | 90.225% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 1,050 | 9.775% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.823% | 99.897% | 99.150% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[bak-default]` | 0.337 | 0.096 | 34.8 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `bak-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 9,669 | 94.564% (92.675–95.406) | 94.807% (92.643–95.764) | 92.130% (91.396–92.962) |
| 20% | 8,600 | 94.695% (93.731–95.450) | 94.976% (93.679–95.559) | 94.194% (92.090–94.444) |
| 30% | 7,506 | 94.745% (93.808–96.363) | 94.850% (93.898–96.497) | 93.919% (92.973–95.135) |
| 40% | 6,475 | 95.232% (94.707–95.814) | 95.196% (94.646–95.984) | 95.118% (93.533–95.563) |
| 50% | 5,393 | 95.179% (93.232–96.115) | 95.307% (93.053–96.272) | 94.697% (93.182–96.183) |
| 60% | 4,295 | 95.074% (94.656–96.497) | 95.082% (94.615–96.554) | 95.035% (93.128–95.972) |
| 70% | 3,263 | 95.221% (94.637–96.636) | 95.152% (94.565–96.681) | 95.283% (92.722–96.215) |
| 80% | 2,157 | 95.178% (94.265–96.219) | 95.123% (94.204–96.272) | 95.283% (91.509–95.714) |
| 90% | 1,077 | 95.079% (94.013–95.810) | 95.060% (93.880–96.281) | 95.283% (91.509–95.283) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **94.807%** at 10% training knowledge to **95.060%** at 90%, a measured **+0.253 percentage-point** change.
- Unseen all-form exactness moves from **94.564%** at 10% training knowledge to **95.079%** at 90%, a measured **+0.515 percentage-point** change.
- Preservation of unseen already-root forms moves from **92.130%** at 10% training knowledge to **95.283%** at 90%, a measured **+3.153 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `BAK` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `bak-default`, loaded from classpath resource `org/egothor/stemmer/models/bak-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.998782** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.998782** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.998782|0.000000%|0.243700%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.997563|1.000000|0.998782|0.999998|0.000002|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.999512|0.998780|0.998049|0.997563|0.998781|0.998780|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|55261|0|135|57430607|0 / 57430607|135 / 55396|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|55396|0|0|57430607|0 / 57430607|0 / 55396|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|135|0|0|19|0.177189%|2|10742|
