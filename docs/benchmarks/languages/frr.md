# North Frisian Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 364 distinct usable word forms" title="Relative dictionary size 1 of 5; 364 distinct usable word forms">★☆☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `frr-default` North Frisian model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 364 distinct usable word forms" title="Relative dictionary size 1 of 5; 364 distinct usable word forms">★☆☆☆☆</span>. The exact count is **364 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `frr-default` | `1.0.0` | `FRR` | 51 | 364 | 381 | 51 | 330 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **381**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 30 | 7.874% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 238 | 62.467% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 61 | 16.010% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 48 | 12.598% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 4 | 1.050% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 95.538% | 96.061% | 92.157% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[frr-default]` | 0.231 | 0.061 | 46.3 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `frr-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 340 | 23.599% (20.235–27.059) | 15.593% (8.475–18.056) | 91.304% (77.273–95.652) |
| 20% | 300 | 29.934% (28.620–35.333) | 20.833% (18.359–25.769) | 92.500% (87.805–97.500) |
| 30% | 264 | 33.333% (27.138–37.879) | 24.336% (19.313–28.384) | 91.429% (77.778–100.000) |
| 40% | 229 | 33.188% (26.316–38.565) | 24.020% (15.736–31.088) | 93.548% (86.667–100.000) |
| 50% | 186 | 32.447% (26.064–40.909) | 24.324% (15.854–32.895) | 91.667% (86.364–100.000) |
| 60% | 142 | 32.394% (30.263–39.437) | 23.387% (21.053–31.707) | 94.737% (77.778–100.000) |
| 70% | 111 | 30.357% (29.245–48.571) | 23.232% (17.582–41.111) | 92.857% (84.615–100.000) |
| 80% | 71 | 31.818% (22.667–56.923) | 22.222% (13.636–50.909) | 88.889% (62.500–100.000) |
| 90% | 37 | 29.730% (21.739–53.571) | 25.000% (14.286–47.826) | 80.000% (66.667–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **15.593%** at 10% training knowledge to **25.000%** at 90%, a measured **+9.407 percentage-point** change.
- Unseen all-form exactness moves from **23.599%** at 10% training knowledge to **29.730%** at 90%, a measured **+6.131 percentage-point** change.
- Preservation of unseen already-root forms moves from **91.304%** at 10% training knowledge to **80.000%** at 90%, a measured **-11.304 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `FRR` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `frr-default`, loaded from classpath resource `org/egothor/stemmer/models/frr-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.954614** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.954614** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.954614|0.000000%|9.077156%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.909228|1.000000|0.954614|0.998184|0.001816|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.980424|0.952456|0.926040|0.909228|0.953535|0.952652|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1202|0|120|64744|0 / 64744|120 / 1322|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|1322|0|0|64744|0 / 64744|0 / 1322|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|120|0|0|17|4.670330%|2|381|
