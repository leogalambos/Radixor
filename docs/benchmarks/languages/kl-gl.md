# Kalaallisut Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 321 distinct usable word forms" title="Relative dictionary size 1 of 5; 321 distinct usable word forms">★☆☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `kl-gl-default` Kalaallisut model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 321 distinct usable word forms" title="Relative dictionary size 1 of 5; 321 distinct usable word forms">★☆☆☆☆</span>. The exact count is **321 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `kl-gl-default` | `1.0.0` | `KL_GL` | 23 | 321 | 321 | 23 | 298 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **321**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 164 | 51.090% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 125 | 38.941% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 23 | 7.165% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 9 | 2.804% |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[kl-gl-default]` | 0.205 | 0.056 | 40.9 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `kl-gl-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 293 | 21.502% (7.850–29.693) | 15.441% (0.735–26.103) | 100.000% (76.190–100.000) |
| 20% | 251 | 21.514% (8.367–33.865) | 15.451% (1.288–29.185) | 100.000% (94.444–100.000) |
| 30% | 223 | 26.457% (8.072–32.735) | 21.256% (0.966–27.536) | 93.750% (93.750–100.000) |
| 40% | 195 | 23.590% (21.026–28.718) | 17.680% (14.917–23.204) | 100.000% (92.857–100.000) |
| 50% | 153 | 22.078% (14.379–29.412) | 16.084% (7.746–23.944) | 100.000% |
| 60% | 125 | 20.800% (12.800–30.952) | 14.655% (6.034–25.641) | 100.000% |
| 70% | 98 | 17.526% (11.224–28.571) | 11.111% (4.396–23.077) | 100.000% |
| 80% | 70 | 26.087% (7.246–31.429) | 20.312% (0.000–26.154) | 100.000% |
| 90% | 28 | 28.571% (7.143–75.000) | 23.077% (0.000–73.077) | 100.000% |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **15.441%** at 10% training knowledge to **23.077%** at 90%, a measured **+7.636 percentage-point** change.
- Unseen all-form exactness moves from **21.502%** at 10% training knowledge to **28.571%** at 90%, a measured **+7.070 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `KL_GL` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `kl-gl-default`, loaded from classpath resource `org/egothor/stemmer/models/kl-gl-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|2080|0|0|49280|0 / 49280|0 / 2080|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|2080|0|0|49280|0 / 49280|0 / 2080|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|0|0|0|0|0.000000%|1|321|
