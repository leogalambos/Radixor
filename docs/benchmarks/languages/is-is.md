# Icelandic Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 52,197 distinct usable word forms" title="Relative dictionary size 4 of 5; 52,197 distinct usable word forms">★★★★☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `is-is-default` Icelandic model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 52,197 distinct usable word forms" title="Relative dictionary size 4 of 5; 52,197 distinct usable word forms">★★★★☆</span>. The exact count is **52,197 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `is-is-default` | `1.0.0` | `IS_IS` | 4,772 | 52,197 | 53,388 | 4,772 | 48,616 | changed tokens | 48,616 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **53,388**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 239 | 0.448% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 25,490 | 47.745% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 20,329 | 38.078% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 4,855 | 9.094% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 2,475 | 4.636% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 97.769% | 97.748% | 97.988% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[is-is-default]` | 4.558 | 0.639 | 93.7 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `is-is-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 47,839 | 47.359% (45.806–47.853) | 43.922% (42.363–44.487) | 82.097% (80.468–82.846) |
| 20% | 42,353 | 52.643% (51.376–53.000) | 49.578% (48.304–50.022) | 83.294% (82.782–84.766) |
| 30% | 36,883 | 55.572% (54.757–56.370) | 52.696% (51.938–53.522) | 85.505% (83.693–87.120) |
| 40% | 31,507 | 57.580% (56.882–57.842) | 54.646% (53.900–55.045) | 87.442% (85.776–87.790) |
| 50% | 26,119 | 59.244% (58.720–59.451) | 56.433% (55.741–56.818) | 87.967% (86.583–89.537) |
| 60% | 20,771 | 60.579% (60.281–60.931) | 57.821% (57.431–58.036) | 89.411% (87.216–90.535) |
| 70% | 15,482 | 61.305% (60.755–62.259) | 58.577% (57.919–59.577) | 89.462% (88.501–89.753) |
| 80% | 10,259 | 62.943% (61.744–63.349) | 60.284% (59.010–60.723) | 90.220% (89.531–90.497) |
| 90% | 5,139 | 64.289% (61.499–65.188) | 61.732% (58.785–62.751) | 90.414% (89.912–90.828) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **43.922%** at 10% training knowledge to **61.732%** at 90%, a measured **+17.811 percentage-point** change.
- Unseen all-form exactness moves from **47.359%** at 10% training knowledge to **64.289%** at 90%, a measured **+16.930 percentage-point** change.
- Preservation of unseen already-root forms moves from **82.097%** at 10% training knowledge to **90.414%** at 90%, a measured **+8.317 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `IS_IS` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `is-is-default`, loaded from classpath resource `org/egothor/stemmer/models/is-is-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.981831** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.981831** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.981831|0.000000%|3.633824%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.963662|1.000000|0.981831|0.999992|0.000008|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.992515|0.981495|0.970717|0.963662|0.981663|0.981659|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|280812|0|10589|1361945905|0 / 1361945905|10589 / 291401|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|291401|0|0|1361945905|0 / 1361945905|0 / 291401|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|10589|0|0|1114|2.134222%|29|53388|
