# Cornish Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 162 distinct usable word forms" title="Relative dictionary size 1 of 5; 162 distinct usable word forms">★☆☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `cor-default` Cornish model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 162 distinct usable word forms" title="Relative dictionary size 1 of 5; 162 distinct usable word forms">★☆☆☆☆</span>. The exact count is **162 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `cor-default` | `1.0.0` | `COR` | 8 | 162 | 174 | 8 | 166 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **174**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 2 | 1.149% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 160 | 91.954% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 2 | 1.149% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 8 | 4.598% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 2 | 1.149% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 93.103% | 92.771% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[cor-default]` | 0.240 | 0.066 | 47.9 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `cor-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 157 | 7.006% (2.685–8.696) | 3.333% (0.000–3.817) | 85.714% (57.143–100.000) |
| 20% | 132 | 7.483% (5.357–8.850) | 4.255% (0.943–4.673) | 83.333% |
| 30% | 132 | 7.483% (5.357–8.850) | 4.255% (0.943–4.673) | 83.333% |
| 40% | 110 | 5.405% (3.922–8.264) | 0.943% (0.000–5.172) | 80.000% (80.000–100.000) |
| 50% | 73 | 6.154% (3.529–8.219) | 0.000% (0.000–5.797) | 75.000% (50.000–100.000) |
| 60% | 48 | 6.250% (2.703–14.583) | 0.000% (0.000–8.889) | 100.000% (33.333–100.000) |
| 70% | 21 | 12.766% (4.167–18.182) | 0.000% (0.000–8.889) | 100.000% |
| 80% | 21 | 12.766% (4.167–18.182) | 0.000% (0.000–8.889) | 100.000% |
| 90% | 11 | 9.091% (9.091–100.000) | 0.000% | 100.000% |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **3.333%** at 10% training knowledge to **0.000%** at 90%, a measured **-3.333 percentage-point** change.
- Unseen all-form exactness moves from **7.006%** at 10% training knowledge to **9.091%** at 90%, a measured **+2.085 percentage-point** change.
- Preservation of unseen already-root forms moves from **85.714%** at 10% training knowledge to **100.000%** at 90%, a measured **+14.286 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `COR` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `cor-default`, loaded from classpath resource `org/egothor/stemmer/models/cor-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.997378** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.997378** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.997378|0.000000%|0.524476%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.994755|1.000000|0.997378|0.999080|0.000920|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.998947|0.997371|0.995800|0.994755|0.997374|0.996818|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|2276|0|12|10753|0 / 10753|12 / 2288|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|2288|0|0|10753|0 / 10753|0 / 2288|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|12|0|0|12|7.407407%|2|174|
