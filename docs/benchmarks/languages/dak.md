# Dakota Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 3,332 distinct usable word forms" title="Relative dictionary size 3 of 5; 3,332 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `dak-default` Dakota model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 3,332 distinct usable word forms" title="Relative dictionary size 3 of 5; 3,332 distinct usable word forms">★★★☆☆</span>. The exact count is **3,332 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `dak-default` | `1.0.0` | `DAK` | 473 | 3,332 | 3,358 | 473 | 2,885 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **3,358**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 2,599 | 77.397% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 260 | 7.743% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 473 | 14.086% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 26 | 0.774% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.226% | 99.133% | 99.789% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[dak-default]` | 0.409 | 0.104 | 81.9 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `dak-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 3,021 | 19.185% (15.619–20.563) | 6.481% (2.696–7.977) | 94.836% (92.958–97.412) |
| 20% | 2,676 | 18.498% (17.779–19.933) | 5.962% (5.362–7.472) | 94.974% (92.042–96.021) |
| 30% | 2,333 | 21.046% (18.955–22.889) | 8.837% (6.920–10.984) | 93.636% (92.727–95.152) |
| 40% | 2,000 | 21.678% (20.435–24.248) | 9.366% (8.387–12.850) | 93.310% (92.580–96.466) |
| 50% | 1,657 | 22.269% (21.553–23.778) | 10.134% (9.397–12.197) | 94.894% (91.915–95.339) |
| 60% | 1,325 | 23.925% (21.278–24.851) | 12.148% (9.019–13.247) | 95.745% (92.553–96.296) |
| 70% | 992 | 24.093% (23.124–24.476) | 12.235% (11.834–12.922) | 95.070% (90.780–96.454) |
| 80% | 662 | 23.845% (23.688–26.300) | 12.153% (11.888–14.286) | 94.737% (94.681–98.947) |
| 90% | 326 | 24.375% (21.951–28.840) | 12.545% (9.609–17.216) | 95.745% (89.362–97.872) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **6.481%** at 10% training knowledge to **12.545%** at 90%, a measured **+6.063 percentage-point** change.
- Unseen all-form exactness moves from **19.185%** at 10% training knowledge to **24.375%** at 90%, a measured **+5.190 percentage-point** change.
- Preservation of unseen already-root forms moves from **94.836%** at 10% training knowledge to **95.745%** at 90%, a measured **+0.909 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `DAK` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `dak-default`, loaded from classpath resource `org/egothor/stemmer/models/dak-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.994385** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.994385** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.994385|0.000000%|1.123047%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.988770|1.000000|0.994385|0.999979|0.000021|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.997734|0.994353|0.990995|0.988770|0.994369|0.994359|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|10125|0|115|5539206|0 / 5539206|115 / 10240|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|10240|0|0|5539206|0 / 5539206|0 / 10240|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|115|0|0|26|0.780312%|2|3358|
