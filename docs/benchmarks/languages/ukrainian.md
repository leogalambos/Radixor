# Ukrainian Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 14,150 distinct usable word forms" title="Relative dictionary size 4 of 5; 14,150 distinct usable word forms">★★★★☆</span>
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `uk-ua-default` | `1.0.0` | `UK_UA` | 1,493 | 14,150 | 15,737 | 2,985 | 12,752 | changed tokens | 12,752 |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `ukrainianRadixor` | 0.625 | 0.015 | 49.0 | 1.000 | Radixor dictionary-trained patch-command stemmer. |
| Lucene HunspellStemFilter | `luceneHunspellStemFilter` | 55.325 | 7.036 | 4338.5 | 88.453 | Benchmark-only Ukrainian Hunspell dictionary compared via Lucene HunspellStemFilter. |
| Morfologik direct | `ukrainianMorfologikDirect` | 8.584 | 0.122 | 673.2 | 13.725 | Direct Morfologik dictionary lookup; first returned stem is used for quality. |
| Lucene MorfologikFilter | `ukrainianLuceneMorfologikFilter` | 15.362 | 0.300 | 1204.6 | 24.560 | Dictionary-based Morfologik TokenFilter; may emit multiple terms. |
...
- Median exactness on genuinely unseen changed forms moves from **42.530%** at 10% training knowledge to **57.218%** at 90%, a measured **+14.689 percentage-point** change.
- Unseen all-form exactness moves from **50.982%** at 10% training knowledge to **63.233%** at 90%, a measured **+12.251 percentage-point** change.
- Preservation of unseen already-root forms moves from **85.464%** at 10% training knowledge to **90.476%** at 90%, a measured **+5.012 percentage-point** change.
