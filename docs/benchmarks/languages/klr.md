# Khinalugh Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 54,602 distinct usable word forms" title="Relative dictionary size 4 of 5; 54,602 distinct usable word forms">★★★★☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `klr-default` Khinalugh model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 54,602 distinct usable word forms" title="Relative dictionary size 4 of 5; 54,602 distinct usable word forms">★★★★☆</span>. The exact count is **54,602 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `klr-default` | `1.0.0` | `KLR` | 591 | 54,602 | 59,637 | 591 | 59,046 | changed tokens | 59,046 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **59,637**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 1 | 0.002% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 54,592 | 91.540% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 4,268 | 7.157% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 592 | 0.993% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 184 | 0.309% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 91.557% | 91.473% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[klr-default]` | 7.866 | 0.854 | 133.2 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `klr-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 52,551 | 7.120% (6.516–8.075) | 6.167% (5.560–7.133) | 100.000% (99.812–100.000) |
| 20% | 45,965 | 7.750% (7.367–8.809) | 6.792% (6.422–7.861) | 100.000% (99.789–100.000) |
| 30% | 39,347 | 7.712% (7.589–8.641) | 6.738% (6.606–7.664) | 100.000% (99.758–100.000) |
| 40% | 33,181 | 7.505% (6.579–8.113) | 6.504% (5.548–7.125) | 100.000% (99.437–100.000) |
| 50% | 27,059 | 7.417% (6.642–8.527) | 6.397% (5.602–7.526) | 100.000% (99.661–100.000) |
| 60% | 21,089 | 7.225% (6.959–8.578) | 6.167% (5.900–7.543) | 100.000% (99.576–100.000) |
| 70% | 16,046 | 7.716% (6.375–8.050) | 6.682% (5.331–7.017) | 100.000% (99.435–100.000) |
| 80% | 10,373 | 7.299% (6.460–7.719) | 6.228% (5.448–6.656) | 100.000% (99.153–100.000) |
| 90% | 5,193 | 6.586% (6.293–7.570) | 5.512% (5.242–6.477) | 100.000% |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **6.167%** at 10% training knowledge to **5.512%** at 90%, a measured **-0.654 percentage-point** change.
- Unseen all-form exactness moves from **7.120%** at 10% training knowledge to **6.586%** at 90%, a measured **-0.534 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `KLR` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `klr-default`, loaded from classpath resource `org/egothor/stemmer/models/klr-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.944247** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.944247** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.944247|0.000000%|11.150603%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.888494|1.000000|0.944247|0.999757|0.000243|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.975515|0.940955|0.908760|0.888494|0.942600|0.942485|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|2886788|0|362292|1487412821|0 / 1487412821|362292 / 3249080|
...
|---|---:|---:|
|Radixor|0 / 1487412821|0 / 3249080|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|3249080|0|0|1487412821|0 / 1487412821|0 / 3249080|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|362292|0|0|4783|8.759752%|4|59637|
