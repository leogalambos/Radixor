# Sotho, Southern Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 416 distinct usable word forms" title="Relative dictionary size 1 of 5; 416 distinct usable word forms">★☆☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `st-za-default` Sotho, Southern model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 416 distinct usable word forms" title="Relative dictionary size 1 of 5; 416 distinct usable word forms">★☆☆☆☆</span>. The exact count is **416 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `st-za-default` | `1.0.0` | `ST_ZA` | 26 | 416 | 416 | 26 | 390 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **416**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 364 | 87.500% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 26 | 6.250% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 26 | 6.250% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 100.000% | 100.000% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
| Official Snowball direct (Java) | 3.846% | 1.538% | 38.462% | Official Snowball 3.1.0 generated Java stemmer; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[st-za-default]` | 0.250 | 0.064 | 50.1 | 1.000 | Canonical model timing workload; measured in this snapshot. |
| Official Snowball direct (Java) | `snowballDirect[SESOTHO]` | 0.266 | 0.062 | 53.1 | 1.061 | Official generated Java stemmer; measured in this snapshot. The Radixor and Snowball 99.9% JMH intervals overlap; statistically tied, so the runtime ratio is a point estimate only. |
...
Model `st-za-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 368 | 12.500% | 6.667% | 100.000% |
| 20% | 336 | 12.500% | 6.667% | 100.000% |
| 30% | 288 | 12.500% | 6.667% | 100.000% |
| 40% | 256 | 12.500% | 6.667% | 100.000% |
| 50% | 208 | 12.500% | 6.667% | 100.000% |
| 60% | 160 | 12.500% | 6.667% | 100.000% |
| 70% | 128 | 12.500% | 6.667% | 100.000% |
| 80% | 80 | 12.500% | 6.667% | 100.000% |
| 90% | 48 | 12.500% | 6.667% | 100.000% |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **6.667%** at 10% training knowledge to **6.667%** at 90%, a measured **+0.000 percentage-point** change.
- Unseen all-form exactness moves from **12.500%** at 10% training knowledge to **12.500%** at 90%, a measured **+0.000 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `ST_ZA` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `st-za-default`, loaded from classpath resource `org/egothor/stemmer/models/st-za-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **1.000000** among 2 deterministic stemmers. The runner-up is `SNOWBALL SESOTHO DIRECT` at 0.503417, a difference of 0.496583. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **1.000000** among 2 deterministic stemmers. The runner-up is `SNOWBALL SESOTHO DIRECT` at 0.503417, a difference of 0.496583. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|2|SNOWBALL SESOTHO DIRECT|0.503417|0.021635%|99.294872%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|1.000000|1.000000|1.000000|1.000000|0.000000|
|2|SNOWBALL SESOTHO DIRECT|PRIMARY_OUTPUT|0.550000|0.007051|0.999784|0.503417|0.963902|0.036098|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|1.000000|1.000000|1.000000|1.000000|1.000000|
|2|SNOWBALL SESOTHO DIRECT|PRIMARY_OUTPUT|0.033537|0.013924|0.008786|0.007011|0.062275|0.059277|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|3120|0|0|83200|0 / 83200|0 / 3120|
|2|SNOWBALL SESOTHO DIRECT|PRIMARY_OUTPUT|22|18|3098|83182|18 / 83200|3098 / 3120|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|3120|0|0|83200|0 / 83200|0 / 3120|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|0|0|0|0|0.000000%|1|416|
