# Pashto Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,945 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,945 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `ps-af-default` Pashto model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,945 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,945 distinct usable word forms">★★☆☆☆</span>. The exact count is **2,945 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `ps-af-default` | `1.0.0` | `PS_AF` | 381 | 2,945 | 3,064 | 381 | 2,683 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **3,064**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 1 | 0.033% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 1,244 | 40.601% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 777 | 25.359% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 385 | 12.565% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 657 | 21.443% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 96.116% | 95.602% | 99.738% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[ps-af-default]` | 0.254 | 0.080 | 50.7 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `ps-af-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 2,645 | 21.190% (18.601–31.194) | 10.807% (7.425–22.136) | 92.690% (88.889–94.737) |
| 20% | 2,324 | 20.654% (19.205–21.550) | 10.045% (8.245–10.884) | 92.409% (90.789–94.408) |
| 30% | 1,984 | 21.573% (19.838–25.892) | 10.529% (9.205–14.276) | 93.208% (91.353–93.585) |
| 40% | 1,737 | 21.416% (20.849–25.967) | 11.074% (10.473–14.341) | 92.105% (89.381–93.833) |
| 50% | 1,389 | 23.055% (21.855–25.714) | 11.750% (11.084–14.019) | 91.579% (89.362–95.213) |
| 60% | 1,018 | 25.540% (23.182–27.473) | 13.924% (12.159–16.334) | 91.391% (90.667–96.667) |
| 70% | 770 | 24.120% (22.934–28.344) | 12.960% (12.500–17.290) | 91.892% (91.071–93.805) |
| 80% | 531 | 25.697% (22.242–27.637) | 13.828% (12.134–15.824) | 91.892% (86.667–95.946) |
| 90% | 266 | 23.030% (21.053–34.300) | 12.915% (10.044–21.176) | 94.595% (89.189–97.368) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **10.807%** at 10% training knowledge to **12.915%** at 90%, a measured **+2.108 percentage-point** change.
- Unseen all-form exactness moves from **21.190%** at 10% training knowledge to **23.030%** at 90%, a measured **+1.841 percentage-point** change.
- Preservation of unseen already-root forms moves from **92.690%** at 10% training knowledge to **94.595%** at 90%, a measured **+1.905 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `PS_AF` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `ps-af-default`, loaded from classpath resource `org/egothor/stemmer/models/ps-af-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.955597** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.955597** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.955597|0.000000%|8.880639%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.911194|1.000000|0.955597|0.999376|0.000624|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.980880|0.953534|0.927670|0.911194|0.954565|0.954265|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|27734|0|2703|4304603|0 / 4304603|2703 / 30437|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|30437|0|0|4304603|0 / 4304603|0 / 30437|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|2703|0|0|45|1.528014%|39|3064|
