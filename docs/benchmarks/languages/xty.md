# Xipinawa Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,754 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,754 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `xty-default` Xipinawa model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,754 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,754 distinct usable word forms">★★☆☆☆</span>. The exact count is **2,754 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `xty-default` | `1.0.0` | `XTY` | 585 | 2,754 | 2,781 | 585 | 2,196 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **2,781**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 2,192 | 78.821% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 589 | 21.179% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.029% | 98.770% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[xty-default]` | 0.426 | 0.090 | 85.3 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `xty-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 2,490 | 22.427% (21.526–23.387) | 3.406% (3.093–3.478) | 94.667% (89.333–97.524) |
| 20% | 2,208 | 23.535% (22.703–24.784) | 5.422% (4.107–6.452) | 91.863% (90.558–92.934) |
| 30% | 1,930 | 24.271% (23.575–25.538) | 6.415% (5.581–7.842) | 91.667% (90.441–92.647) |
| 40% | 1,656 | 25.260% (24.880–25.604) | 7.573% (6.870–8.187) | 90.831% (90.000–92.286) |
| 50% | 1,378 | 26.084% (25.752–26.763) | 9.065% (8.489–9.446) | 91.034% (88.660–92.734) |
| 60% | 1,098 | 26.993% (26.648–27.778) | 10.115% (9.186–10.814) | 90.598% (88.793–93.913) |
| 70% | 816 | 28.360% (27.406–28.571) | 11.076% (10.526–12.112) | 89.714% (88.506–94.152) |
| 80% | 545 | 28.962% (28.336–30.882) | 12.500% (11.601–14.988) | 89.744% (88.889–94.690) |
| 90% | 269 | 28.839% (25.455–32.584) | 12.440% (10.599–16.746) | 89.474% (81.034–91.228) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **3.406%** at 10% training knowledge to **12.440%** at 90%, a measured **+9.034 percentage-point** change.
- Unseen all-form exactness moves from **22.427%** at 10% training knowledge to **28.839%** at 90%, a measured **+6.412 percentage-point** change.
- Preservation of unseen already-root forms moves from **94.667%** at 10% training knowledge to **89.474%** at 90%, a measured **-5.193 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `XTY` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `xty-default`, loaded from classpath resource `org/egothor/stemmer/models/xty-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.990824** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.990824** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.990824|0.000000%|1.835206%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.981648|1.000000|0.990824|0.999974|0.000026|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.996275|0.990739|0.985264|0.981648|0.990781|0.990769|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|5242|0|98|3785541|0 / 3785541|98 / 5340|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|5340|0|0|3785541|0 / 3785541|0 / 5340|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|98|0|0|23|0.835149%|6|2781|
