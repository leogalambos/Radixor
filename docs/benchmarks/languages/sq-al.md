# Albanian Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 10,218 distinct usable word forms" title="Relative dictionary size 3 of 5; 10,218 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `sq-al-default` Albanian model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 10,218 distinct usable word forms" title="Relative dictionary size 3 of 5; 10,218 distinct usable word forms">★★★☆☆</span>. The exact count is **10,218 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `sq-al-default` | `1.0.0` | `SQ_AL` | 587 | 10,218 | 10,264 | 587 | 9,677 | changed tokens | 9,677 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **10,264**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 150 | 1.461% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 5,517 | 53.751% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 3,421 | 33.330% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 582 | 5.670% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 594 | 5.787% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.552% | 99.576% | 99.148% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[sq-al-default]` | 0.492 | 0.134 | 50.8 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `sq-al-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 9,213 | 70.692% (66.959–71.613) | 69.493% (66.162–70.796) | 85.769% (80.114–90.720) |
| 20% | 8,179 | 73.560% (70.760–74.716) | 72.611% (69.902–73.998) | 88.085% (84.681–89.362) |
| 30% | 7,117 | 74.795% (73.907–76.690) | 74.149% (73.099–76.025) | 85.330% (84.597–87.561) |
| 40% | 6,104 | 75.168% (74.636–79.673) | 74.350% (73.866–79.255) | 86.610% (84.943–88.889) |
| 50% | 5,026 | 77.370% (75.716–78.898) | 76.705% (75.125–78.182) | 86.007% (84.880–90.722) |
| 60% | 4,029 | 77.039% (75.500–79.709) | 76.328% (74.854–79.250) | 87.234% (85.897–90.987) |
| 70% | 2,961 | 77.069% (75.762–81.269) | 76.346% (74.809–80.997) | 86.857% (85.632–91.429) |
| 80% | 1,985 | 76.717% (73.480–84.213) | 75.953% (72.512–84.056) | 88.034% (86.842–90.598) |
| 90% | 940 | 78.064% (76.395–84.163) | 77.573% (75.406–83.859) | 89.655% (83.051–91.525) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **69.493%** at 10% training knowledge to **77.573%** at 90%, a measured **+8.079 percentage-point** change.
- Unseen all-form exactness moves from **70.692%** at 10% training knowledge to **78.064%** at 90%, a measured **+7.372 percentage-point** change.
- Preservation of unseen already-root forms moves from **85.769%** at 10% training knowledge to **89.655%** at 90%, a measured **+3.887 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `SQ_AL` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `sq-al-default`, loaded from classpath resource `org/egothor/stemmer/models/sq-al-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.996960** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.996960** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.996960|0.000000%|0.607958%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.993920|1.000000|0.996960|0.999984|0.000016|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.998778|0.996951|0.995130|0.993920|0.996956|0.996948|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|137491|0|841|52060321|0 / 52060321|841 / 138332|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|138332|0|0|52060321|0 / 52060321|0 / 138332|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|841|0|0|46|0.450186%|2|10264|
