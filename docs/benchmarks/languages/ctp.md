# Western Highland Chatino Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,597 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,597 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `ctp-default` Western Highland Chatino model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 2,597 distinct usable word forms" title="Relative dictionary size 2 of 5; 2,597 distinct usable word forms">★★☆☆☆</span>. The exact count is **2,597 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `ctp-default` | `1.0.0` | `CTP` | 220 | 2,597 | 2,710 | 220 | 2,490 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **2,710**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 2,026 | 74.760% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 464 | 17.122% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 220 | 8.118% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 95.830% | 95.462% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[ctp-default]` | 0.321 | 0.070 | 64.1 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `ctp-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 2,412 | 9.000% (8.708–9.731) | 0.859% (0.687–1.669) | 100.000% |
| 20% | 2,109 | 9.226% (8.772–9.247) | 0.840% (0.466–1.164) | 100.000% |
| 30% | 1,830 | 9.244% (8.502–9.344) | 0.731% (0.347–1.014) | 100.000% |
| 40% | 1,582 | 8.910% (8.661–9.471) | 0.602% (0.490–0.929) | 100.000% |
| 50% | 1,297 | 8.999% (8.538–9.484) | 0.509% (0.366–0.927) | 100.000% |
| 60% | 1,044 | 8.867% (8.246–9.387) | 0.443% (0.216–1.046) | 100.000% |
| 70% | 791 | 8.492% (7.933–9.355) | 0.138% (0.000–1.103) | 100.000% |
| 80% | 494 | 9.278% (7.513–10.230) | 0.227% (0.000–1.660) | 100.000% |
| 90% | 252 | 9.865% (6.567–11.792) | 0.000% (0.000–1.667) | 100.000% |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **0.859%** at 10% training knowledge to **0.000%** at 90%, a measured **-0.859 percentage-point** change.
- Unseen all-form exactness moves from **9.000%** at 10% training knowledge to **9.865%** at 90%, a measured **+0.865 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `CTP` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `ctp-default`, loaded from classpath resource `org/egothor/stemmer/models/ctp-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.971433** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.971433** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.971433|0.000000%|5.713497%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.942865|1.000000|0.971433|0.999693|0.000307|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.988026|0.970592|0.953764|0.942865|0.971012|0.970863|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|17080|0|1035|3352791|0 / 3352791|1035 / 18115|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|18115|0|0|3352791|0 / 3352791|0 / 18115|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|1035|0|0|110|4.235657%|3|2710|
