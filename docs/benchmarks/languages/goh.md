# Old High German Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 5,267 distinct usable word forms" title="Relative dictionary size 3 of 5; 5,267 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `goh-default` Old High German model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 5,267 distinct usable word forms" title="Relative dictionary size 3 of 5; 5,267 distinct usable word forms">★★★☆☆</span>. The exact count is **5,267 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `goh-default` | `1.0.0` | `GOH` | 482 | 5,267 | 5,300 | 482 | 4,818 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **5,300**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 23 | 0.434% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 2,876 | 54.264% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 1,721 | 32.472% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 486 | 9.170% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 194 | 3.660% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.377% | 99.336% | 99.793% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[goh-default]` | 0.338 | 0.090 | 67.6 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `goh-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 4,764 | 39.216% (32.200–41.498) | 34.440% (26.628–37.096) | 85.714% (82.949–87.788) |
| 20% | 4,265 | 43.312% (38.656–44.003) | 39.203% (33.865–39.589) | 87.013% (84.715–87.728) |
| 30% | 3,773 | 44.719% (41.114–45.826) | 40.588% (36.563–41.739) | 87.240% (86.228–89.286) |
| 40% | 3,264 | 46.067% (42.737–47.243) | 41.818% (38.396–43.265) | 88.153% (87.500–88.502) |
| 50% | 2,758 | 46.240% (44.337–47.186) | 42.241% (40.243–43.062) | 88.235% (86.555–89.167) |
| 60% | 2,220 | 45.991% (43.664–47.752) | 42.033% (39.426–44.179) | 89.062% (84.127–90.576) |
| 70% | 1,658 | 47.587% (44.229–51.365) | 43.536% (40.100–47.311) | 90.278% (85.915–93.007) |
| 80% | 1,161 | 48.079% (43.997–52.810) | 44.353% (39.875–49.467) | 91.667% (86.170–92.708) |
| 90% | 548 | 43.163% (40.855–53.467) | 38.998% (36.499–49.400) | 91.667% (89.362–95.833) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **34.440%** at 10% training knowledge to **38.998%** at 90%, a measured **+4.558 percentage-point** change.
- Unseen all-form exactness moves from **39.216%** at 10% training knowledge to **43.163%** at 90%, a measured **+3.947 percentage-point** change.
- Preservation of unseen already-root forms moves from **85.714%** at 10% training knowledge to **91.667%** at 90%, a measured **+5.952 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `GOH` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `goh-default`, loaded from classpath resource `org/egothor/stemmer/models/goh-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.992668** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.992668** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.992668|0.000000%|1.466423%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.985336|1.000000|0.992668|0.999956|0.000044|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.997032|0.992614|0.988234|0.985336|0.992641|0.992619|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|41055|0|611|13826345|0 / 13826345|611 / 41666|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|41666|0|0|13826345|0 / 13826345|0 / 41666|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|611|0|0|33|0.626543%|2|5300|
