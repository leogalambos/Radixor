# Japanese Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 10,848 distinct usable word forms" title="Relative dictionary size 3 of 5; 10,848 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `ja-jp-default` Japanese model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 10,848 distinct usable word forms" title="Relative dictionary size 3 of 5; 10,848 distinct usable word forms">★★★☆☆</span>. The exact count is **10,848 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `ja-jp-default` | `1.0.0` | `JA_JP` | 107 | 10,848 | 11,592 | 107 | 11,485 | changed tokens | 11,485 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **11,592**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 10,962 | 94.565% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 319 | 2.752% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 111 | 0.958% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 200 | 1.725% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 93.582% | 93.522% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[ja-jp-default]` | 1.137 | 0.203 | 99.0 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `ja-jp-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 10,133 | 24.223% (19.027–29.252) | 23.578% (18.330–28.626) | 92.708% (92.632–96.875) |
| 20% | 9,182 | 28.009% (21.292–30.423) | 27.447% (20.600–29.827) | 95.294% (88.372–100.000) |
| 30% | 8,012 | 27.471% (23.357–30.781) | 26.833% (22.715–30.177) | 95.946% (93.243–98.630) |
| 40% | 6,522 | 29.566% (20.132–35.524) | 28.902% (19.399–34.983) | 96.825% (95.238–98.438) |
| 50% | 5,315 | 27.649% (23.698–35.551) | 26.984% (22.938–34.958) | 96.154% (94.231–100.000) |
| 60% | 4,313 | 28.292% (23.997–36.642) | 27.617% (23.279–35.994) | 100.000% (95.349–100.000) |
| 70% | 3,125 | 30.312% (22.755–34.724) | 29.529% (22.050–34.088) | 100.000% (93.750–100.000) |
| 80% | 2,026 | 29.268% (18.252–31.935) | 28.591% (17.410–31.256) | 100.000% |
| 90% | 1,051 | 32.953% (16.580–35.775) | 32.358% (15.612–35.159) | 100.000% |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **23.578%** at 10% training knowledge to **32.358%** at 90%, a measured **+8.780 percentage-point** change.
- Unseen all-form exactness moves from **24.223%** at 10% training knowledge to **32.953%** at 90%, a measured **+8.730 percentage-point** change.
- Preservation of unseen already-root forms moves from **92.708%** at 10% training knowledge to **100.000%** at 90%, a measured **+7.292 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `JA_JP` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `ja-jp-default`, loaded from classpath resource `org/egothor/stemmer/models/ja-jp-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.919503** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.919503** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.919503|0.000000%|16.099332%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.839007|1.000000|0.919503|0.997866|0.002134|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.963041|0.912456|0.866920|0.839007|0.915973|0.914984|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|654296|0|125550|58054282|0 / 58054282|125550 / 779846|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|779846|0|0|58054282|0 / 58054282|0 / 779846|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|125550|0|0|594|5.475664%|3|11592|
