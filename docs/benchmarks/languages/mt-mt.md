# Maltese Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,491 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,491 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `mt-mt-default` Maltese model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,491 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,491 distinct usable word forms">★★☆☆☆</span>. The exact count is **1,491 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `mt-mt-default` | `1.0.0` | `MT_MT` | 112 | 1,491 | 1,500 | 112 | 1,388 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **1,500**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 1,215 | 81.000% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 154 | 10.267% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 113 | 7.533% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 18 | 1.200% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.400% | 99.352% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[mt-mt-default]` | 0.303 | 0.079 | 60.7 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `mt-mt-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 1,351 | 12.435% (8.754–12.702) | 5.578% (1.363–6.027) | 98.020% (88.119–100.000) |
| 20% | 1,199 | 12.010% (10.461–13.756) | 5.140% (3.648–7.918) | 95.556% (86.667–100.000) |
| 30% | 1,038 | 12.694% (11.542–13.572) | 5.765% (4.932–7.121) | 94.872% (92.308–97.436) |
| 40% | 887 | 11.939% (11.387–12.059) | 5.153% (4.390–5.370) | 96.970% (92.424–97.015) |
| 50% | 737 | 12.278% (11.564–13.067) | 5.579% (4.965–6.110) | 96.364% (90.909–100.000) |
| 60% | 592 | 13.007% (10.697–14.480) | 6.093% (4.021–7.749) | 95.556% (95.455–100.000) |
| 70% | 454 | 11.184% (10.538–14.097) | 4.662% (3.632–7.143) | 96.970% (91.176–100.000) |
| 80% | 295 | 13.851% (11.702–15.333) | 7.299% (4.981–8.633) | 95.455% (95.238–100.000) |
| 90% | 144 | 16.667% (8.333–21.333) | 10.072% (1.493–15.108) | 100.000% (90.909–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **5.578%** at 10% training knowledge to **10.072%** at 90%, a measured **+4.494 percentage-point** change.
- Unseen all-form exactness moves from **12.435%** at 10% training knowledge to **16.667%** at 90%, a measured **+4.231 percentage-point** change.
- Preservation of unseen already-root forms moves from **98.020%** at 10% training knowledge to **100.000%** at 90%, a measured **+1.980 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `MT_MT` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `mt-mt-default`, loaded from classpath resource `org/egothor/stemmer/models/mt-mt-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.996750** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.996750** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.996750|0.000000%|0.649904%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.993501|1.000000|0.996750|0.999945|0.000055|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.998693|0.996740|0.994794|0.993501|0.996745|0.996718|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|9325|0|61|1101409|0 / 1101409|61 / 9386|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|9386|0|0|1101409|0 / 1101409|0 / 9386|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|61|0|0|9|0.603622%|2|1500|
