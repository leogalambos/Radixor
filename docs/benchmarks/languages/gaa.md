# Ga Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 469 distinct usable word forms" title="Relative dictionary size 1 of 5; 469 distinct usable word forms">★☆☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `gaa-default` Ga model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 469 distinct usable word forms" title="Relative dictionary size 1 of 5; 469 distinct usable word forms">★☆☆☆☆</span>. The exact count is **469 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `gaa-default` | `1.0.0` | `GAA` | 94 | 469 | 470 | 94 | 376 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **470**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 186 | 39.574% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 189 | 40.213% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 95 | 20.213% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.787% | 99.734% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[gaa-default]` | 0.150 | 0.043 | 30.0 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `gaa-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 425 | 56.000% (53.176–58.491) | 50.000% (42.353–50.147) | 91.765% (80.000–100.000) |
| 20% | 375 | 58.133% (57.067–59.358) | 50.000% (47.333–50.167) | 96.000% (90.667–100.000) |
| 30% | 329 | 60.000% (56.231–60.182) | 50.000% (46.970–50.190) | 100.000% (92.308–100.000) |
| 40% | 280 | 59.643% (57.143–60.215) | 50.000% (46.429–50.224) | 100.000% (98.182–100.000) |
| 50% | 234 | 60.000% (59.402–60.256) | 50.000% (50.000–50.267) | 100.000% (97.826–100.000) |
| 60% | 189 | 60.000% (59.259–60.317) | 50.000% (50.000–50.331) | 100.000% (97.297–100.000) |
| 70% | 139 | 60.000% (58.993–60.432) | 50.000% (50.000–50.450) | 100.000% (96.296–100.000) |
| 80% | 94 | 60.000% (58.511–60.638) | 50.000% (50.000–50.667) | 100.000% (94.444–100.000) |
| 90% | 44 | 60.000% (59.091–61.364) | 50.000% (50.000–51.429) | 100.000% |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **50.000%** at 10% training knowledge to **50.000%** at 90%, a measured **+0.000 percentage-point** change.
- Unseen all-form exactness moves from **56.000%** at 10% training knowledge to **60.000%** at 90%, a measured **+4.000 percentage-point** change.
- Preservation of unseen already-root forms moves from **91.765%** at 10% training knowledge to **100.000%** at 90%, a measured **+8.235 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `GAA` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `gaa-default`, loaded from classpath resource `org/egothor/stemmer/models/gaa-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.997872** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.997872** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.997872|0.000000%|0.425532%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.995745|1.000000|0.997872|0.999964|0.000036|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.999146|0.997868|0.996593|0.995745|0.997870|0.997852|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|936|0|4|108806|0 / 108806|4 / 940|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|940|0|0|108806|0 / 108806|0 / 940|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|4|0|0|1|0.213220%|2|470|
