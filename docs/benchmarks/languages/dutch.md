# Dutch Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 4 of 5; 26,201 distinct usable word forms" title="Relative dictionary size 4 of 5; 26,201 distinct usable word forms">★★★★☆</span>
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `nl-nl-default` | `1.0.0` | `NL_NL` | 4,992 | 26,201 | 31,466 | 9,981 | 21,485 | changed tokens | 21,485 |
...
| Official Snowball direct (Java) | 15.954% | 8.992% | 30.939% | Official Snowball generated Java stemmer; rule-based suffix algorithm. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[nl-nl-default]` | 1.684 | 0.303 | 78.4 | 1.000 | Radixor dictionary-trained patch-command stemmer. |
| Lucene HunspellStemFilter | `luceneHunspellStemFilter` | 28.188 | 4.287 | 1312.0 | 16.739 | Benchmark-only Dutch Hunspell dictionary compared via Lucene HunspellStemFilter. |
| Official Snowball direct (Java) | `snowballDirect[DUTCH]` | 4.365 | 0.323 | 203.2 | 2.592 | Official Snowball generated Java stemmer; direct API. |
| Lucene SnowballFilter | `luceneSnowballFilter[DUTCH]` | 7.631 | 0.387 | 355.2 | 4.531 | Lucene TokenFilter path around Snowball; includes TokenStream overhead. |
...
- Median exactness on genuinely unseen changed forms moves from **55.524%** at 10% training knowledge to **65.891%** at 90%, a measured **+10.366 percentage-point** change.
- Unseen all-form exactness moves from **67.039%** at 10% training knowledge to **74.468%** at 90%, a measured **+7.429 percentage-point** change.
- Preservation of unseen already-root forms moves from **92.616%** at 10% training knowledge to **94.512%** at 90%, a measured **+1.896 percentage-point** change.
