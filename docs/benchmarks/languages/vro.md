# Voro Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 412 distinct usable word forms" title="Relative dictionary size 1 of 5; 412 distinct usable word forms">★☆☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `vro-default` Voro model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 412 distinct usable word forms" title="Relative dictionary size 1 of 5; 412 distinct usable word forms">★☆☆☆☆</span>. The exact count is **412 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `vro-default` | `1.0.0` | `VRO` | 63 | 412 | 413 | 63 | 350 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **413**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 3 | 0.726% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 275 | 66.586% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 59 | 14.286% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 63 | 15.254% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 13 | 3.148% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.758% | 99.714% | 100.000% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[vro-default]` | 0.235 | 0.064 | 47.0 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `vro-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 373 | 15.385% (13.793–17.158) | 1.250% (0.000–2.532) | 94.737% (87.719–98.246) |
| 20% | 331 | 16.566% (14.154–16.928) | 1.859% (0.712–3.546) | 92.000% (84.000–98.000) |
| 30% | 288 | 16.495% (13.732–16.897) | 2.128% (0.410–3.644) | 88.636% (81.818–97.727) |
| 40% | 249 | 15.936% (13.765–16.929) | 2.778% (1.493–3.318) | 86.842% (76.316–97.368) |
| 50% | 203 | 16.256% (15.897–16.432) | 2.326% (1.220–4.396) | 93.548% (87.097–96.774) |
| 60% | 162 | 16.352% (15.476–18.519) | 2.985% (1.504–5.839) | 88.000% (88.000–96.000) |
| 70% | 123 | 16.667% (15.200–17.778) | 2.105% (1.031–6.897) | 89.474% (84.211–94.737) |
| 80% | 81 | 15.957% (14.444–18.519) | 3.077% (0.000–4.938) | 92.308% (76.923–100.000) |
| 90% | 41 | 16.667% (11.111–23.256) | 2.564% (0.000–10.811) | 100.000% (66.667–100.000) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **1.250%** at 10% training knowledge to **2.564%** at 90%, a measured **+1.314 percentage-point** change.
- Unseen all-form exactness moves from **15.385%** at 10% training knowledge to **16.667%** at 90%, a measured **+1.282 percentage-point** change.
- Preservation of unseen already-root forms moves from **94.737%** at 10% training knowledge to **100.000%** at 90%, a measured **+5.263 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `VRO` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `vro-default`, loaded from classpath resource `org/egothor/stemmer/models/vro-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.998340** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.998340** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.998340|0.000000%|0.331950%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.996680|1.000000|0.998340|0.999953|0.000047|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.999334|0.998337|0.997343|0.996680|0.998339|0.998315|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1201|0|4|83461|0 / 83461|4 / 1205|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|1205|0|0|83461|0 / 83461|0 / 1205|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|4|0|0|1|0.242718%|2|413|
