# Crimean Tatar Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 7,195 distinct usable word forms" title="Relative dictionary size 3 of 5; 7,195 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `crh-default` Crimean Tatar model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 7,195 distinct usable word forms" title="Relative dictionary size 3 of 5; 7,195 distinct usable word forms">★★★☆☆</span>. The exact count is **7,195 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `crh-default` | `1.0.0` | `CRH` | 1,210 | 7,195 | 7,199 | 1,210 | 5,989 | changed tokens | 5,989 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **7,199**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 241 | 3.348% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 5,746 | 79.817% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 1,212 | 16.836% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 99.944% | 99.950% | 99.917% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[crh-default]` | 0.145 | 0.040 | 24.2 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `crh-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 6,479 | 94.366% (93.781–94.628) | 94.212% (93.990–94.730) | 94.123% (90.993–95.588) |
| 20% | 5,758 | 94.340% (92.480–95.084) | 94.864% (92.321–95.177) | 94.623% (91.736–95.346) |
| 30% | 5,036 | 95.092% (93.467–95.955) | 95.206% (93.009–96.282) | 95.035% (93.853–95.740) |
| 40% | 4,314 | 95.228% (94.576–95.435) | 95.210% (94.290–95.566) | 95.317% (94.069–95.994) |
| 50% | 3,593 | 95.243% (94.766–95.606) | 95.154% (94.779–95.822) | 94.702% (94.205–96.026) |
| 60% | 2,876 | 95.028% (94.286–95.859) | 95.029% (93.758–96.151) | 94.617% (93.375–96.894) |
| 70% | 2,159 | 95.370% (93.948–95.926) | 95.442% (93.169–96.105) | 95.028% (93.113–97.790) |
| 80% | 1,438 | 95.271% (94.367–96.181) | 94.987% (93.787–96.414) | 95.021% (92.562–98.340) |
| 90% | 717 | 95.556% (94.693–96.111) | 95.477% (93.792–96.500) | 95.041% (94.167–99.167) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **94.212%** at 10% training knowledge to **95.477%** at 90%, a measured **+1.266 percentage-point** change.
- Unseen all-form exactness moves from **94.366%** at 10% training knowledge to **95.556%** at 90%, a measured **+1.189 percentage-point** change.
- Preservation of unseen already-root forms moves from **94.123%** at 10% training knowledge to **95.041%** at 90%, a measured **+0.918 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `CRH` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `crh-default`, loaded from classpath resource `org/egothor/stemmer/models/crh-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.999524** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.999524** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.999524|0.000000%|0.095265%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.999047|1.000000|0.999524|0.999999|0.000001|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.999809|0.999523|0.999238|0.999047|0.999524|0.999523|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|17828|0|17|25862570|0 / 25862570|17 / 17845|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|17845|0|0|25862570|0 / 25862570|0 / 17845|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|17|0|0|4|0.055594%|2|7199|
