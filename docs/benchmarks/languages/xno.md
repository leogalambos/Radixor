# Anglo-Norman Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 186 distinct usable word forms" title="Relative dictionary size 1 of 5; 186 distinct usable word forms">★☆☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `xno-default` Anglo-Norman model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 1 of 5; 186 distinct usable word forms" title="Relative dictionary size 1 of 5; 186 distinct usable word forms">★☆☆☆☆</span>. The exact count is **186 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `xno-default` | `1.0.0` | `XNO` | 5 | 186 | 186 | 5 | 181 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **186**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 148 | 79.570% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 31 | 16.667% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 5 | 2.688% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 2 | 1.075% |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[xno-default]` | 0.249 | 0.070 | 49.8 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `xno-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 151 | 39.735% (0.704–39.735) | 38.095% (0.000–38.095) | 100.000% (25.000–100.000) |
| 20% | 151 | 39.735% (0.704–39.735) | 38.095% (0.000–38.095) | 100.000% (25.000–100.000) |
| 30% | 116 | 23.364% (21.552–44.860) | 21.154% (19.469–43.269) | 100.000% |
| 40% | 116 | 23.364% (21.552–44.860) | 21.154% (19.469–43.269) | 100.000% |
| 50% | 72 | 8.571% (2.469–50.000) | 5.882% (0.000–48.571) | 100.000% (50.000–100.000) |
| 60% | 72 | 8.571% (2.469–50.000) | 5.882% (0.000–48.571) | 100.000% (50.000–100.000) |
| 70% | 35 | 8.571% (2.703–100.000) | 5.882% (0.000–100.000) | 100.000% |
| 80% | 35 | 8.571% (2.703–100.000) | 5.882% (0.000–100.000) | 100.000% |
| 90% | 0 | n/a | n/a | n/a |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms is **n/a** at one or both endpoints because the corresponding evaluated population is empty.
- Unseen all-form exactness is **n/a** at one or both endpoints because the corresponding evaluated population is empty.
- Preservation of unseen already-root forms is **n/a** at one or both endpoints because the corresponding evaluated population is empty.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `XNO` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `xno-default`, loaded from classpath resource `org/egothor/stemmer/models/xno-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|3397|0|0|13808|0 / 13808|0 / 3397|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|3397|0|0|13808|0 / 13808|0 / 3397|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|0|0|0|0|0.000000%|1|186|
