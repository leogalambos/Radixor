# Oodham Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,159 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,159 distinct usable word forms">★★☆☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `ood-default` Oodham model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 2 of 5; 1,159 distinct usable word forms" title="Relative dictionary size 2 of 5; 1,159 distinct usable word forms">★★☆☆☆</span>. The exact count is **1,159 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `ood-default` | `1.0.0` | `OOD` | 368 | 1,159 | 1,178 | 368 | 810 | changed tokens | 5,000 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **1,178**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 31 | 2.632% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 492 | 41.766% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 279 | 23.684% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 372 | 31.579% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 4 | 0.340% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 98.387% | 97.778% | 99.728% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[ood-default]` | 0.329 | 0.067 | 65.8 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `ood-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 1,047 | 36.381% (32.625–36.682) | 8.616% (5.816–11.549) | 92.727% (89.728–95.770) |
| 20% | 936 | 35.543% (34.342–37.074) | 10.280% (8.466–11.493) | 92.177% (89.796–95.222) |
| 30% | 811 | 36.059% (33.539–38.509) | 10.182% (7.052–12.409) | 91.440% (89.494–94.163) |
| 40% | 705 | 36.018% (34.468–37.912) | 7.930% (6.834–13.976) | 93.665% (91.364–95.909) |
| 50% | 576 | 36.458% (35.195–38.143) | 8.906% (7.084–13.810) | 93.478% (90.164–95.628) |
| 60% | 454 | 35.759% (33.333–36.585) | 8.418% (7.792–11.148) | 89.726% (89.116–96.575) |
| 70% | 338 | 36.152% (34.320–38.663) | 9.009% (6.987–11.966) | 91.743% (88.991–95.455) |
| 80% | 231 | 35.169% (32.035–38.288) | 8.025% (6.329–12.865) | 87.838% (86.486–94.595) |
| 90% | 109 | 34.862% (31.746–41.748) | 9.722% (8.989–12.500) | 91.667% (83.784–94.595) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **8.616%** at 10% training knowledge to **9.722%** at 90%, a measured **+1.106 percentage-point** change.
- Unseen all-form exactness moves from **36.381%** at 10% training knowledge to **34.862%** at 90%, a measured **-1.519 percentage-point** change.
- Preservation of unseen already-root forms moves from **92.727%** at 10% training knowledge to **91.667%** at 90%, a measured **-1.061 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `OOD` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `ood-default`, loaded from classpath resource `org/egothor/stemmer/models/ood-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.988769** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.988769** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.988769|0.000000%|2.246139%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.977539|1.000000|0.988769|0.999928|0.000072|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.995426|0.988642|0.981950|0.977539|0.988706|0.988670|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|2089|0|48|668924|0 / 668924|48 / 2137|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|2137|0|0|668924|0 / 668924|0 / 2137|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|48|0|0|19|1.639344%|2|1178|
