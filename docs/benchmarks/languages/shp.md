# Shipibo-Conibo Stemmer Benchmarks <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 7,729 distinct usable word forms" title="Relative dictionary size 3 of 5; 7,729 distinct usable word forms">★★★☆☆</span>

This page reports dictionary corpus, exact-root agreement, and runtime evidence for the independently available `shp-default` Shipibo-Conibo model.

<!-- DICTIONARY-SIZE-RATING:START -->
Dictionary size: <span class="dictionary-rating" role="img" aria-label="Relative dictionary size 3 of 5; 7,729 distinct usable word forms" title="Relative dictionary size 3 of 5; 7,729 distinct usable word forms">★★★☆☆</span>. The exact count is **7,729 distinct usable word forms** after parser-compatible filtering and exact, case-preserved deduplication. Stars rank dictionary size relative to all benchmarked dictionaries in five nearly equal groups; they do **not** measure linguistic quality or benchmark accuracy.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `shp-default` | `1.0.0` | `SHP` | 1,999 | 7,729 | 7,972 | 1,999 | 5,973 | changed tokens | 5,973 |

## Radixor Patch Command Distribution

Radixor stores the preferred transformation for each normalized dictionary word form as a compiled patch command. This distribution shows which runtime command class is selected by the trained trie for the complete default-model dictionary. The total number of preferred patch commands analyzed for this language is **7,972**.

| Command class | Meaning | Word forms | Share |
| --- | --- | ---: | ---: |
| `AppendCharacterCommand` | Appends one character to the end of the word form. | 6 | 0.075% |
| `BackwardCompoundCommand` | Applies a multi-step backward patch made from skip, delete, insert, and replace operations. | 423 | 5.306% |
| `DeleteSuffixCommand` | Deletes one or more trailing characters from the word form. | 5,556 | 69.694% |
| `PreserveCommand` | Returns the word form unchanged because it already matches the preferred root. | 1,979 | 24.824% |
| `ReplaceLastCharacterCommand` | Replaces the final character of the word form. | 8 | 0.100% |
...
| --- | ---: | ---: | ---: | --- |
| Radixor | 96.952% | 97.271% | 95.998% | Exact model-ID benchmark; measured in this snapshot. |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Radixor | `radixor[shp-default]` | 0.192 | 0.056 | 32.2 | 1.000 | Canonical model timing workload; measured in this snapshot. |
...
Model `shp-default` version `1.0.0` is evaluated over five
...
| ---: | ---: | ---: | ---: | ---: |
| 10% | 7,089 | 81.553% (79.770–82.254) | 78.067% (76.244–79.762) | 90.711% (87.787–91.895) |
| 20% | 6,276 | 81.886% (80.003–83.270) | 78.450% (76.312–81.085) | 91.001% (89.784–92.094) |
| 30% | 5,451 | 81.968% (81.563–83.087) | 78.568% (78.042–80.336) | 91.860% (91.256–92.347) |
| 40% | 4,649 | 82.709% (82.111–82.970) | 79.503% (78.469–79.769) | 92.255% (90.987–93.035) |
| 50% | 3,858 | 83.044% (82.271–83.589) | 79.736% (78.549–80.201) | 93.458% (92.340–93.821) |
| 60% | 3,084 | 82.821% (82.754–83.722) | 79.699% (78.784–80.242) | 93.995% (92.298–94.961) |
| 70% | 2,297 | 83.777% (83.123–84.491) | 80.264% (79.191–81.312) | 94.170% (91.930–95.288) |
| 80% | 1,526 | 84.112% (83.083–84.712) | 80.617% (80.225–81.195) | 94.947% (91.799–95.789) |
| 90% | 757 | 84.655% (83.884–85.411) | 81.206% (79.965–82.526) | 95.722% (93.717–97.895) |

### Generalization conclusion

- Median exactness on genuinely unseen changed forms moves from **78.067%** at 10% training knowledge to **81.206%** at 90%, a measured **+3.139 percentage-point** change.
- Unseen all-form exactness moves from **81.553%** at 10% training knowledge to **84.655%** at 90%, a measured **+3.102 percentage-point** change.
- Preservation of unseen already-root forms moves from **90.711%** at 10% training knowledge to **95.722%** at 90%, a measured **+5.011 percentage-point** change.
...
Runtime performance and linguistic grouping quality are independent dimensions. This section evaluates language `SHP` using the complete validated stemming-quality result matrix. Every distinct surface form is one evaluated item and can belong to several dictionary groups. Two forms are a positive pair when their group-membership sets intersect and a negative pair when those sets are disjoint. A pair shared through several groups is counted once. Exact equality with a predetermined lemma is not required.

`ALL_WORDS` includes every valid group and its original forms. `LOWERCASE_GROUPS_ONLY` excludes an entire group when any Unicode code point is uppercase or titlecase; retained words are not lowercased or otherwise rewritten. This isolates case-handling effects without changing retained inputs. [Download the complete machine-readable result snapshot](../data/stemming-quality-2026-09-11.csv).

### Evaluation Scope and Key Findings

The default model is `shp-default`, loaded from classpath resource `org/egothor/stemmer/models/shp-default/stemmer.gz`. The following findings compare only deterministic `PRIMARY_OUTPUT` rows over identical included groups; candidate policies are reported separately as capability analyses.

- **ALL_WORDS:** `Radixor` ranks first by balanced accuracy at **0.978699** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
- **LOWERCASE_GROUPS_ONLY:** `Radixor` ranks first by balanced accuracy at **0.978699** among 1 deterministic stemmers; no same-language competitor was available. This rank does not imply leadership in throughput or every secondary metric.
### `ALL_WORDS`
...
|---:|---|---:|---:|---:|
|1|Radixor|0.978699|0.000000%|4.260276%|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|1.000000|0.957397|1.000000|0.978699|0.999983|0.000017|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|0.991179|0.978235|0.965625|0.957397|0.978467|0.978458|
...
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|PRIMARY_OUTPUT|11506|0|512|29852838|0 / 29852838|512 / 12018|
...
| Rank | Stemmer | Output policy | TP | FP | FN | TN | Over error / possible | Under error / possible |
|---:|---|---|---:|---:|---:|---:|---:|---:|
|1|Radixor|ALL_CANDIDATES|12018|0|0|29852838|0 / 29852838|0 / 12018|
...
|---|---:|---:|---:|---:|---:|---:|---:|
|Radixor|512|0|0|165|2.134817%|21|7972|
